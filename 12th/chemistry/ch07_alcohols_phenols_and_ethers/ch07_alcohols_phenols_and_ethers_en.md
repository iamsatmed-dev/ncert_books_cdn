# NCERT: 12TH_CHEMISTRY_CH07_ALCOHOLS_PHENOLS_AND_ETHERS_CH07_ALCOHOLS_PHENOLS_AND_ETHERS_EN
...
(i) Compounds containing Csp³-OH bond: In this class of alcohols,
...
(ii) Compounds containing Csp2-OH bond: These alcohols contain
...
(i) By reduction of aldehydes and ketones: Alde
...
aluminium hydride (LiAlH₄). Aldehydes yield primary alcohols
...
Give the structures and IUPAC names of the produc
...
acidic acidic in nature. In fact, alcohols and phenols are Brönsted
...
causes the oxygen of –OH group to be
...
Table 7.3: pK Values of some Phenols and Ethanol
...
The reactions invo involving cleavage of C–O bond take place only in
...
nding which causes the association
...
7.6 Give structures of the produc products you would expect when each of the
...
The formation of ether is a nucleophilic bimolecular reaction (S2)
...
CH-C-ONa + CH-Br →CH-O-C-CH3 + NaBr
...
CH3-C-Br + NaO- NaÖ-CH3 CH3-C=CH2+NaBr
...
ion formed in step 1 and displaces an alcohol molecule by S2 mechanism.
...
(i) CH3-CH2-CH-CH2OH + CH3CH2I (ii) CH3CH2CH2OH + CH3CH2-C-1 Solution
...
(ii) cyclohexylmethanol using an alkyl halide by an S2 reaction.
...
(i) C₂H₂OCH2 - CH -CH₃ (ii) CH3OCH2CH2Cl
...
7.4 (i) CH3-CH-MgBr + HCHO → CH3-CH-CH2
...
CH3-CH2 - CH – CH – ONa + C₂H₄Br → CH₃ – CH₂ – CH – CH – OC2H5
