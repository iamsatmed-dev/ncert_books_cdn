# NCERT: 12TH_CHEMISTRY_CH10_BIOMOLECULES_CH10_BIOMOLECULES_EN
...
them have a general formula, C₁(H2O)y, and were considered as hydrates
...
(ii) Oligosaccharides: Carbohydrates that yield two to
...
### 5. Acetylation
of glucose with acetic anhydride gives glucose
...
(CHOH), Acetic anhydride (CH-O-C-CH3)4
...
and ẞ-form, are called anomers. The six membered cyclic structure
of glucose is called pyranose structure (a- or ẞ-), in analogy with
...
It also exists in two cyclic forms which are obtained D – (-) – Fructose
...
C12 H22 O11 + H₂O → C6H12 06 + C6H12O6
...
linkage between C1 of a-D-glucose and C2 of ẞ-D-fructose. Since
...
disaccharide is found in milk. It is composed of ẞ-D-galactose and
...
constituent of cell wall of plant cells. Cellulose is a
...
polysaccharide composed only of ẞ-D-glucose units which are
...
classified as α, β, γ, δ and so on. Only a-amino
...
Table 10.2: Natural Amino Acids H₂N
...
Characteristic feature Three letter One letter
...
You have already read that proteins are the polymers of a-amino acids
...
a pep
a 
peptide bond –CO–NH-. The product of the reaction
...
If If a third amino acid combines to a dipeptide, the product is called a
...
ẞ-pleated sheet structure. These structures arise due
...
>C=0 of an adjacent turn of the helix as shown in Fig.10.1.
...
In ẞ-pleated sheet structure all peptide chains are
...
N-H-- structure of proteins represents overall folding of the
...
stabilise the 2º and 3° structures of proteins are
...
acid hydrolysis of sucrose is 6.22 kJ mol¯¹, while the activation energy is
only 2.15 kJ mol¯¹ when hydrolysed by the enzyme, sucrase. Mechanism
...
of Nucleic
DNA molecules, the sugar moiety is ẞ-D-2-deoxyribose whereas in
Acids
RNA molecule, it is ẞ-D-ribose.
...
A unit formed by the attachment to 1' position of sugar is
...
A simplified version of nucleic acid
