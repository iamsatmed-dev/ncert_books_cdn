# NCERT: 12TH_CHEMISTRY_CH05_COORDINATION_COMPOUNDS_CH05_COORDINATION_COMPOUNDS_EN
...
On the basis of the following observations made with aqueous solutions, Example 5.1
...
Both double salts as well as complexes are formed
ormed 
by the combination
...
Mohr's salt, FeSO4.(NH4)2SO4.6H2O, potash alum, KAI(SO4)2.12H2O, etc.
dissociate into simple ions completely when dissolved in water. However,

complex ions such as as [Fe(CN)6]* of K4[Fe(CN)6] do not dissociate into
...
### 5.2 Definitions of (a) Coordination entity
...
are [Ni(CO)4], [PtCl2(NH3)2], [Fe(CN)6], [Co(NH3)6]³+.
...
[CoCl(NH3)5]2+ and [Fe(CN)6]³¯ are Ni2+, Co³+ and Fe3+, respectively.
...
to be polydentate. Ethylenediaminetetraacetate ion (EDTA) is
...
O ligand. Examples of such ligands are the NO2 and
...
directly bonded. For example, in the complex ions, [PtCl6]² and
[Ni(NH3)4]2+, the coordination number of Pt and Ni are 6 and 4
respectively. Similarly, in the complex ions, [Fe(C2O4)3]³ and
[Co(en)3]³+, the coordination number of both, Fe and Co, is 6 because
...
the coordination sphere is [Fe(CN)6] and the counter ion is K⁺.
...
number of copper in [Cu(CN)4]³¯ is +1 and it is written as Cu(I).
...
### 5.3 Nomenclature Nomenclature is important in Coordination Chemistry because of the
...
### 5.3.1 Formulas of The formula of a compound is a shorthand tool used to provide basic
...
sign. For example, [Co(CN)6]³¯, [Cr(H2O)6]³+, etc.
...
Mononuclear principles of additive nomenclature. Thus, the groups that surround the
Coordination central atom must be identified in the name. They are listed as prefixes
Compounds to the name of the central atom along with any appropriate multipliers.
...
(ii) The ligands are named in in an alphabe
an alphabetical 
order before the name of the
...
ligands are the same except aqua for H₂O, ammine for NH3, carbonyl
...
anion, [Co(SCN)4] is called cobaltate. For some metals, the Latin
...
Since it takes 3 sulphates to bond with two comple complex cations, the
...
Solution (a) [Co(NH3)₄(H₂O)Cl]Cl₂

(d) [CoCl2(en)2]+

(b) K₂[Zn(OH)4] (c) K3[Al(C2O4)3]
(e) [Ni(CO)4]
...
Solution (a) diamminechloridonitrito-N-platinum(II)
...
Why is geometrical isomerism not possible in tetrahedral complexes Example 5.4

having two different types of unidentate ligands coordinated with
the central metal ion ?

Tetrahedral complexes do not show geometrical isomerism because Solution
...
Example 5.5 Draw structures of geometrical isomers of [Fe(NH3)2(CN)4]
...
Example 5.6 Out of the following two coordination entities which is chiral
...
bound to Co³t and the CN ligands to Cr³+. In its coordination
isomer [Cr(NH3)6][Co(CN)6], the NH3 ligands are bound to Cr³⁺ and the
CN ligands to Co³+.
...
### 5.4 Give evidence that [Co(NH3)5C1]SO4 and [Co(NH3)5(SO4)]Cl are ionisation
...
the complex, [Co(NH3)6]³+ is called an inner orbital or low spin or spin
paired complex. The paramagnetic octahedral complex, [CoF]³ uses
outer orbital (4d) in hybridisation (sp³ď²). It is thus called outer orbital
...
An example is [Ni(CN)4]²¯. Here nickel is in +2 oxidation state and has
the electronic configuration 3d. The hybridisation scheme is as shown
in diagram:
...
metal ions with upto three electrons in the d orbitals, like Ti³+ (d'); V³+
(d²); Cr³+ (d³); two vacant d orbitals are available for octahedral
...
Hund's rule). Thus, for d⁺ (Cr2+, Mn³+), d5 (Mn2+, Fe3+), dº (Fe2+, Co³+)
...
especially with coordination compounds containing dº ions. However,
with species containing d⁺ and ď ions there are complications. [Mn(CN)6]3-
has magnetic moment of two unpaired electrons while [MnCl]³¯ has a
paramagnetic moment of four unpaired electrons. [Fe(CN)6]³ has magnetic
moment of a single unpaired electron while [FeF6]³ has a paramagnetic
moment of five unpaired electrons. [CoF]³ is paramagnetic with four
unpaired electrons while [Co(C2O4)3]³ is diamagnetic. This apparent
anomaly is explained by valence bond theory in terms of formation of
inner orbital and outer orbital coordination entities. [Mn(CN)6]³¯, [Fe(CN)6]³¯
and [Co(C2O4)3]³ are inner orbital complexes involving desp³ hybridisation,
the former two complexes are paramagnetic and the latter diamagnetic.
On the other hand, [MnCl], [FeF｡] and [CoF]³ are outer orbital
complexes involving spď² hybridisation and are paramagnetic
...
Example 5.7 The spin only magnetic moment of [MnBr4]²¯ is 5.9 BM. Predict the
geometry of the complex ion ?

Solution Since the coordination number of Mn2+ ion in the complex ion is 4, it
will be either tetrahedral (sp³ hybridisation) or square planar (dsp²
...
planar because of the presence of five unpaired electrons in the dorbitals.
...
like NH3 and H₂O) in a complex, it becomes asymmetrical and the
...
the liga
the 
ligand than when it is away from the ligand. Thus, the dx2-y2
and d₂2 orbitals which point towards the axes along the direction of
the ligand will experience more repulsion and will be raised in
energy; and the dxy, dyz and d₁₂ orbitals which are directed between
...
set and two orbitals of higher energy, e set. This splitting of the
...
Splitting of d orbitals ligands are able to produce
...
I¯ < Br¯ < SCN¯ < Cl¯ < S²¯ < F¯ < OH® < C2O4²¯ < H₂O < NCS¯
< edta⁴¯ < NH3 < en < CN¯ < CO
...
d' and d³ coordination entities, the d electrons occupy the t₂g orbitals
singly in accordance with the Hund's rule. For d⁺ ions, two possible
...
e level. Which of these possibilities occurs, depends on the relative
magnitude of the crystal field splitting, ∆。 and the pairing energy, P
(P represents the energy required for electron pairing in a single
orbital). The two options are:

(i) If ∆｡ < P, the fourth electron enters one of the e orbitals giving the
configuration te. Ligands for which ∆｡ < P are known as weak
...
(ii) If A > P, it becomes more energetically favourable for the fourth
electron to occupy a t₂g orbital with configuration tage. Ligands
which produce this effect are known as strong field ligands and
form low spin complexes.

Calculations show that ď to d' coordination entities are more
...
be shown that ∆₁ = (4/9) Δο. Consequently,
...
Compounds This means that some of the visible spectrum is being removed from
...
Colour of light Colour of coordination
absorbed
entity
...
[Ti(H2O)6]³+, which is violet in colour. This is an octahedral complex
where the single electron (Ti³⁺ is a 3d¹ system) in the metal d orbital is
in the t₂g level in the ground state of the complex. The next higher state
...
[Ni(H2O)4 (en)]2+(aq) + en (aq)

[Ni(H2O)2(en)2]2+(aq) + en (aq)

=

=

[Ni(H2O)2(en)2]2+(aq) + 2H2O
blue/purple
...
(a)
Fig.5.12: (a) Ruby: this gemstone was found in
...
### 5.5 Explain on the basis of valence bond theory that [Ni(CN)4]² ion with square
planar structure is diamagnetic and the [NiCl4] ion with tetrahedral
geometry is paramagnetic.

### 5.6 [NiCl4]² is paramagnetic while [Ni(CO)4] O)4] is diamagnetic though both are
tetrahedral. Why?

### 5.7 [Fe(H2O)6]3+ is strongly paramagnetic whereas [Fe(CN)6]³ is weakly
paramagnetic. Explain.

### 5.8 Explain [Co(NH3)6]³⁺ is an inner orbital complex whereas [Ni(NH3)6]2+ is an
outer orbital complex.

### 5.9 Predict the number of unpaired electrons in the square planar [Pt(CN)4]² ion.
...
(dimethylglyoxime), a-nitroso–ẞ-naphthol, cupron, etc.
...
The metal-carbon bond in metal carbonyls possesses both σ and πcharacter.
The ligand to metal is o bond and metal to ligand is a bond. This unique synergic
...
5.2 FeSO4 solution mixed with (NH4)2SO4 solution in 1:1 molar ratio gives the
...
### 5.3 Explain with two examples each of the following: coordination entity, ligand,
coordination number, coordination polyhedron, homoleptic and heteroleptic.

### 5.4 What is meant by unidentate, didentate and ambidentate ligands? Give two
examples for each.
...
(ii) [Pt(NH3)2C1(NH2CH3)]Cl

(iii) [Ti(H2O)6]3+

(iv) [Co(NH3)4Cl(NO2)]Cl (vii) [Ni(NH3)6]C12
...
### 5.8 List various types of isomerism possible for coordination compounds, giving
...
of copper sulphide is obtained when H₂S(g) is passed through this solution?
5.15 Discuss the nature of bonding in the following coordination entities on the

(iii) [Co(C2O4)3]³ (iv) [CoF]³
...
### 5.18 What is crystal field splitting energy? How does the magnitude of A decide
the actual configuration of d orbitals in a coordination entity?
5.19 [Cr(NH3)6]³+ is paramagnetic while [Ni(CN)4]² is diamagnetic. Explain why?
5.20 A solution of [Ni(H2O)6]²⁺ is_green_but a solution of [Ni(CN)4]² [Ni(CN)4]²¯ is is colourless.

Explain.

### 5.21 [Fe(CN)6] and [Fe(H2O)6]²⁺ are_of different colours in dilute solutions. Why?
...
### 5.25 Explain the violet colour of the complex [Ti(H2O)6]³+ on the basis of crystal
...
(i) [Fe(H2O)6]³+ (ii) [Fe(NH3)6]3+ (iii) [Fe(C2O4)3]³
...
are 10 possible isomers. (Hint: There are geometrical, ionisation and

linkage isomers possible).

(iv) Geometrical (cis-, trans-) isomers can exist.

### 5.4 The ionisation isomers dissolve in water to yield different ions and thus react

differently to various reagents:

2+

[Co(NH3)5Br]SO4 + Ba²+ → BaSO4 (s)

2+

[Co(NH3)5SO4]Br + Ba²+ → No reaction

[Co(NH3)5Br]SO₄ + Ag* → No reaction

[Co(NH3)5SO4]Br + Ag+ → AgBr (s)

2-

### 5.6 In Ni(CO)4, Ni is in zero oxidation state whereas in NiCl42, it is in +2 oxidation
...
### 5.7 In presence of CN, (a strong ligand) the 3d electrons pair up leaving only one
unpaired electron. The hybridisation is d²sp³ forming inner orbital complex. In
the presence of H₂O, (a weak ligand), 3d electrons do not pair up. The
hybridisation is sp³ď forming an outer orbital complex containing five unpaired
electrons, it is strongly paramagnetic.

### 5.8 In the presence of NH3, the 3d electrons pair up leaving two d orbitals empty
to be involved in desp³ hybridisation forming inner orbital complex in case of [Co(NH3)6]3+.
In Ni(NH3)62+, Ni is in +2 oxidation state and has de configuration, the
hybridisation involved is sp³d² forming outer orbital complex.

### 5.9 For square planar shape, the hybridisation is dsp². Hence the unpaired electrons
in 5d orbital pair up to make one d orbital empty for dsp² hybridisation. Thus
