# NCERT: 12TH_CHEMISTRY_CH03_CHEMICAL_KINETICS_CH03_CHEMICAL_KINETICS_EN
...
distinguish between elementary different properties. For any chemical reaction, chemists
...
are their concentrations at time t₂ then,
...
Since, A[R] is a negative quantity (as concentration of reactants is
...
concentration time¯¹. For example, if concentration is in mol L¯¹ and
time is in seconds then the units will be mol L¯¹s¯¹. However, in gaseous
...
From the concentrations of C₂H₄Cl (butyl chloride) at different times given Example 3.1
...
It can be seen (Table 3.1) that the average rate falls from 1.90 × 0⁴ mol L¯¹s¯¹ to
0.4 × 10^4 mol L¯¹s¯¹. However, average rate cannot be used to predict the
...
when At approaches zero). Hence, mathematically hematically for an infinitesimally
...
either of the curves for concentration of R and Pvs time t and calculating
...
mol L¯¹ = 5.12 × 10¯5 mol L¯¹s-1

At t = 250 s

Finst = 1.22 × 104 mol L¯¹s-1

t = 350 s

rinst = 1.0 × 10¯4 mol L¯¹s-1

t = 450 s

Tinst = 6.4 ×× 10-5 mol L¯¹s¯¹

Now consider a reaction

Hg(l) + Cl2 (g) → HgCl₂(s)

Where stoichiometric coefficients of the reactants and products products are
...
HI decompose to produce one mole each of H₂ and I2.
...
rate of consumption of HI is twice the rate of formation of H₂ or I₂, to
...
5 Br (aq) + BrO3 (aq) + 6 H+ (aq) → 3 Br₂ (aq) + 3 H2O (1)

Rate =

1 A[Br] A[Bro] 1 Δ[H+] 1 Δ[Br₂] 1 Δ[H2O]
...
Example 3.2 The decomposition of N₂O, in CCl4 at 318K has been studied by
monitoring the concentration of N2O5 in the solution. Initially the
concentration of N₂O₃ is 2.33 mol L¯¹ and after 184 minutes, it is reduced
to 2.08 mol L¯¹. The reaction takes place according to the equation

2 N2O5 (g) → 4 NO2 (g) + O2 (g)

Calculate the average rate of this reaction in terms of hours, minutes
and seconds. What is the rate of production of NO₂ during this period?
...
6.79 × 10¯4 mol L¯¹/min = (6.79 × 10¯⁴ mol L¯¹ min¯¹) × (60 min/1h)
4.07 × 102 mol L¯¹/h
...
6.79 × 10^ × 4 mol L¯¹ min 10¯4 × 4 mol L¯¹ min¯¹ = 2.72 × 10¯³ mol L¯¹min¯¹
...
where kis a proportionality constant called rate constant. The
...
Initial [NO]/ mol L¯¹ Initial [O2]/ mol L¹
...
of NO is doubled and that of O₂ is kept constant then the initial rate
increases by a factor of four from 0.096 to 0.384 mol L¯¹s¯¹. This
...
O₂ is doubled the rate also gets doubled indicating that rate depends
on concentration of O₂ to the first power. Hence, the rate equation for
...
Rate = k [CHCl3] [CL]1/2
2. CH3COOH + H₂O → CH3COOH + ₂OH_Rate = k[CH3COOC2H5]¹ [H₂O]º
...
x and y indicate how sensitive the rate is to the cha
...
chemical reaction. can be 0. 1. 2.
...
Taking SI units of concentration, mol L¯¹ and time, s, the units of
...
(i) k = 2.3 × 10-5 L mol¯¹ s-1

(ii) k = 3 × 10^4 s¯¹

b

(i) The unit of second order rate constant is L mol¯¹ s¯¹, therefore Solution

-1

k = 2.3 × 10-5 L mol¯¹ s¯¹ represents a second order reaction.

(ii) The unit of a first order rate constant is s¯¹ therefore

k = 3 × 10^4 s¯¹ represents a first order reaction.
...
This reaction is first order with respect to both H₂O2 and I. Evidences
...
of slope of the tangent at point ‘ť in concentration vs time plot
...
At_t = 0, the concentration of the reactant R = [R], where [R]。 is
...
When_t = 0, R = [R], where [R]。 is the initial concentration of the
...
where, [R]₁ and [R]2 are the concentrations of the reactants at time
...
Refer to Appendix-IV for In and log (logarithms).
...
Fig. 3.4: A plot between In[R] and t
...
Fig. 3.5: Plot of log [R]/[R] vs time for a

Decomposition of N₂O, and N₂O
...
are some more examples of first

Example 3.5 The initial concentration of N2O5 in the following first order reaction
N₂O₃(g) → 2 NO2(g) + 1/202 (g) was 1.24 × 10-2 mol L¯¹ at 318 K. The
concentration of of N₂O₃ after 60 minutes was 0.20 × 10-2 mol L¯¹. Calculate

5

the rate constant of the reaction at 318 Κ.
...
Let p₁ be the initial pressure of A and p₁ the total pressure at
time 't. Integrated rate equation for such a reaction can be derived as
Total pressure p₁ = PA + PB + pc (pressure units)
...
For zero order reaction t1/2 ∝ [R]. For first order reaction
t1/2 is independent of [R].

A first order reaction is found to have a rate constant, k = 5.5 × 10-14 s¹. Example 3.7
...
### 3.5 A first order reaction has a rate constant 1.15 × 10¯³ s¯¹. How long will 5 g
...
### 3.4 Temperature
Dependence of original amount of material to decompose is 12 min at 50°C, 5 h at
the Rate of a
Reaction
...
25°C and 10 days at 0°C. You also know that in a mixture of potassium
...
R is gas constant and E is activation energy measured in joules/mole
(J mol¯¹).
...
Fig. 3.6: Formation of HI through
the intermediate
...
We can mark the position of E on
Maxwell Boltzmann distribution curve
(Fig. 3.9).

Increasing the temperature of the substance increases the fraction
of molecules, which collide with energies greater than E. It is clear
...
and intercept = In
A. So we can calculate E and A using these values.
At temperature T₁, equation (3.19) is

not to be

1/T

Fig. 3.10: A plot between In k and 1/T
...
k₁ and k₂ are the values of rate constants at
...
0.07s¯¹ respectively. Calculate the values of E and A.
...
log=2.303R 2.303R TT2

Ea

### 2.303×8.314 JK-mol 700-500

0.544 = E × 5.714 × 10^/19.15

-4

700 × 500

E = 0.544 × 19.15/5.714 × 10^4 = 18230.8 J
...
at 600K is 1.60 × 105 s¯¹. Its energy of activation is 209 kJ/mol.
...
log (1.60×10-5) + 2.303×8.314 Jmol LK-¹ 600K 700K
...
not alter Gibbs energy, AG of a reaction. It
...
and e-Ea /RT represents the fraction of molecules with energies equal to
...
Fig. 3.12: Diagram showing molecules having proper and
...
is 209.5 kJ mol¯¹ at 581K. Calculate the fraction of molecules of reactants
...
(k = Ae-Ea/RT). E corresponds to the activation energy and is given by the
...
thus, modifying the Arrhenius equation to_k = PZABE
...
(iv) C2H5Cl (g) → C₂H₄ (g) + HCl (g)

### 3.2 For the reaction:

2A + B → A2B

the rate = k[A][B]² with k = 2.0 × 106 mol-2 L2 s¯¹. Calculate the initial
rate of the reaction when [A] = 0.1 mol L¯¹, [B] = 0.2 mol L¯¹. Calculate
the rate of reaction after [A] is reduced to 0.06 mol L-¹.

### 3.3 The decomposition of NH, on platinum surface is zero order reaction. What
are the rates of production of N₂ and H₂ if k = 2.5 × 10¯⁴ mol¯¹ Ls¯¹?
...
### 3.10 In a reaction between A and B, the initial rate of reaction (r) was measured
...
10² × [N2O]/ 1.63 1.36 1.14 0.93 0.78 0.64 0.53 0.43 0.35
...
### 3.16 The rate constant for a first order reaction is 60 s¯¹. How much time will
...
decomposition of SO₂Cl₂ at a constant volume.
...
### 3.22 The rate constant for the decomposition of ₂O at various temperatures
...
Draw a graph between Ink and 1/T and calculate the values of A and
E. Predict the rate constant at 30° and 50°C.
...
### 3.27 The rate constant for the first order decomposition of H₂O₂ is given by the
...
Calculate E for this reaction and at what temperature will its half-period
be 256 minutes?

### 3.28 The decomposition of A into product has value of k as 4.5 × 103 s¯¹ at 10°C
and energy of activation 60 kJ mol-¹. At what temperature would k be
1.5 × 10's-1?
...
4 × 1010s-1. Calculate kat 318K and E.
