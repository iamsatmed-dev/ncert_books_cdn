# NCERT: 12TH_CHEMISTRY_CH09_AMINES_CH09_AMINES_EN
...
9.2 Classification Amines are classified as primary (1°), secondary (2°) and tertiary (3°)
...
is replaced by R or Ar, we get RNH₂ or ArNH₂, a primary amine (1º).
...
CHNH, is the simplest example of arylamine. In common system, it
...
‘amine'. Thus in IUPAC system, CH¸−NH₂ is named as benzenamine.
...
scrap and hydrochloric acid is preferred because
...
(i) Reaction of ethanolic NH3 with C₂HCl.
...
(i) C₂H₃-Cl C2H5-NH2 →C₂H₃-N-C2H5 →

Solution

+

2H5-N-CH C₂H₃C (CH) NC1
...
N-Ethylethanamine N,N-Diethylethanamine
...
(ii) CH-CH2-Cl into CH5-CH2-CH2-NH2
...
Difference in electronegativity electronegativity between nitrogen and hydrogen atoms and
...
base. The pK values of few amines are given in Table 9.3.
...
Table 9.3: pK Values of Amines in Aqueous Phase
...
state as evident by their pK values given in Table 9.3. In the
...
the alkyl group, e.g., from –CH3 to −C₂H₃ results in change of the order
...
formed and shifts the equilibrium to the right
...
Amines also react with benzoyl chloride (CHCOCl). This reaction
...
R-NH2 + HNO2 NaNO2 + HCl [R-NCI] H₂O
...
Benzenesulphonyl chloride (CHSO₂Cl), which is also known as
...
(i) C₂H₂NH2, CHNH2, NH3, CHCH2NH₂ and (C₂H₃)₂NH

(ii) C₂H₄NH2, (C₂H₄)2NH, (C₂H₄)N, CHNH₂

(iii) CH3NH2, (CH3)2NH, (CH3)3N, CHNH, CHCH2NH2.
...
formula,
CHON. Write IUPAC names of the isomers which will liberate nitrogen gas on
treatment with nitrous acid.

II. DIAZONIUM SALTS

The diazonium salts have the general formula RN2X where R stands
for an aryl group and X ion may be Cľ Br, HSO, BF, etc. They are
...
group. For example,C6H5N2 C1 is named as benzenediazonium
chloride and CH5N2HSO4 HSO is known as benzenediazonium
hydrogensulphate.
...
ArN,Cl + HBF → Ar-N₂BF Ar-F + BF3 + N2
...
of Diazonium good intermediates for the introduction of -F, Cl, -Br, -1, -CN, –OH,
Salts in
...
amines by RN, RNR'R" or R₂NR'. Secondary and tertiary amines are known as
