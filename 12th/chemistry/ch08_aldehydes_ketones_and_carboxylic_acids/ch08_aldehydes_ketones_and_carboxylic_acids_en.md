# NCERT: 12TH_CHEMISTRY_CH08_ALDEHYDES_KETONES_AND_CARBOXYLIC_ACIDS_CH08_ALDEHYDES_KETONES_AND_CARBOXYLIC_ACIDS_EN
...
In the prev previous Unit, you have studied organic
...
a-carbon being the one directly linked to the aldehyde group, β-
...
substituents are indicated by Greek letters, a α΄, β β' and so on
...
CH3-C-H CH-CH2-CH2 CH-CH-CH2-C-H
...
Note: To give identical treatment to all aldehydic
groups, the compound is named as shown above.
...
The carbonyl carbon atom is sp²-hybridised and forms three sigma (σ)
bonds. The fourth valence electron of carbon remains in its p-orbital
and forms a π-bond with oxygen by overlap with p-orbital of an oxygen.
...
CH₂CH₂CH₂CHO, CH₂CH₂CH₂CH₂OH, HC2-O-C₂H₃, CH₂CH₂CH₂CH₂
...
CH3CH2CH2CH₃ < H₄C2-O-C₂H₃ < CH3CH2CH2CHO < CH3CH2CH2CH2OH
...
ketones due to steric reasons. The hydrog
...
to yield alkoxyalcohol xyalcohol intermediate, known as hemiacetals,
...
as ammonia and its derivatives H₂N-Z add to the carbonyl
...
strong oxidising agents and at elevated temperatures. ratures. Their oxidation
...
of CH3CO group or CH3CH(OH) group which produces 
on oxidation.

Example 8.4 An organic compound (A) with molecular formula O forms an
...
as catalyst to form ẞ-hydroxy aldehydes (aldol) or ẞ-hydroxy
...
The aldol and ketol readily lose water to give a,ẞ-unsaturated
...
from two molecules of ethanal 2-Methylpent-2-enal
...
Solution (i) CH₂CH₂CH₂CH₂OH Jones reagent
...
C-R comparable molecular masses. This is due to more extensive
...
C-R with increasing number of carbon atoms. Higher
...
where Keq, is equilibrium constant and K is the acid dissociation
...
The pK of hydrochloric acid is –7.0, where as pK of trifluoroacetic
...
acids than alcohols and many simple phenols (pK is ~16 for ethanol
...
CF3COOH > CC13COOH > CHC12COOH > NO2CH2COOH > NC-CH2COOH >
...
and is easily replaced by chlorine atom on treating with PC15, PC13 or
...
(i) CH3CO₂H or CH2FCO₂H
(ii) CH2FCO₂H or CH₂CICO₂H
(iii) CH2FCH₂CH₂CO₂H or CH₃CHFCH2CO2H
...
possible, give also common common names.
...
any inorganic reagent and any organic reagent having not more than
carbon atom
...
(i) CH₂FCOOH (ii) CH₂FCOOH (iii) CH3CHFCH2COOH (iv) FC
