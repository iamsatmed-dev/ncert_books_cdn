# NCERT: 12TH_CHEMISTRY_CH06_HALOALKANES_AND_HALOARENES_CH06_HALOALKANES_AND_HALOARENES_EN
...
halogen atom(s) attached to the sp³ hybridised carbon
atom of an alkyl group whereas haloarenes contain
halogen atom(s) attached to sp² hybridised carbon
...
primary alkyl halide or 1º alkyl halide. Similarly, if halogen is attached
...
sp³-hybridised carbon atom adjacent to carbon-carbon double bond
...
a sp²-hybridised carbon atom of a carbon-carbon double bond
(C = C).
...
bonded to the sp²-hybridised carbon atom of an aromatic ring.
...
CH3CH2CH(Cl)CH3 sec-Butyl chloride
...
molecular formula C₄H₁₁Br. Name each isomer according to IUPAC system
...
C-X Bond enthalpies/ kJmol-1 Dipole moment/Debye
...
along with gases SO₂ and HCl. The two gaseous products are escapable,
...
CH3CH = CH2+ H-I → CH₂CH₂CH₂I + CH3CHICH
...
bromides with Nal in dry acetone. This reaction is known as Finkelstein
reaction.
...
of the diazonium group by –Cl or –Br.
...
(ii) CH3-CH2-CH=CH2 + HCI -

HH

CH2-C=CH2 + HBr Peroxide,
...
ranching. For example, 2-bromo-2-methylpropane has the lowest
...
### 1. 1. Nucleop Nucleophilic substitution
...
halides in which halogen is bonded to sp³ hybridised carbon. The
...
(a) Substitution nucleophilic bimolecular (S2)。
...
It depicts a bimolecular nucleophilic substitution (S2) reaction;
...
Spacial arrangement of functional groups
...
simple alkyl halides, methyl halides react most rapidly in S2 reactions
...
(b) Substitution nucleophilic unimolecular (S1)
...
will be the rate of reaction. In case of alkyl halides, 3º alkyl halides undergo S№1 reaction
very fast because of the high stability of 3º carbocations. We can sum up the order of reactivity
of alkyl halides towards SŊ1 and SŊ2 reactions as follows:

For S2 reaction

Tertiary halide; Secondary halide; Primary halide; CHX
...
halide, R-X, follows the same order in both the
...
It is primary halide and therefore undergoes S2 Solution
...
compounds in S₁1 and S2 reactions:

(i) The four isomeric bromobutanes

(ii) CHCH2Br, CH₂CH(CH)Br, CHCH(CH3)Br, CH₄C(CH3)(CH₃)Br
...
Solution (i) CH₂CH₂CH₂CH₂Br < (CH₃)₂CHCH2Br < CH3CH2CH(Br)CH₃ < (CH3)3CBr (S1)
...
CHC(CH3)(CH₃)Br < CH3CH(CH₃)Br < CHCH(CH3)Br < CH₂CH₂Br (S2)
Of the two secondary bromides, the carbocation intermediate obtained
from CHCH(CH)Br is more stable than obtained from CH3CH(CH3)Br
because it is stabilised by two phenyl groups due to resonance. Therefore,
the former bromide is more reactive than the latter in S1 reactions. A
phenyl group is bulkier than a methyl group. Therefore, CH3CH(CH₃)Br
is less reactive than CHCH(CH3)Br in S2 reactions.
...
Fig 6.5: B is mirror image of A; B is rotated by 180° and C is
...
bromochloro-iodomethane (BrC1CHI), 2-bromopropanoic
(H3C-CHBr-COOH), etc.
...
the reactant and prod
product is same but the sign of optical rotation
...
Now let us have a fresh look at S₁1 and S2 mechanisms by
...
Thus, S2 reactions of optically active halides are accompanied by
inversion of configuration.

In case of optically active alkyl halides, SŊl reactions are
...
When a haloalkane with ẞ-hydrogen atom is heated with alcoholic
solution of potassium hydroxide, there is elimination of hydrogen
atom from ẞ-carbon and a halogen atom from the a-carbon atom.
...
As a result, an alkene is formed as a product. Since ẞ-hydrogen
atom is involved in elimination, it is often called ẞ-elimination.

If there is possibility of formation of more than one alkene due to
the availability of more than one ẞ-hydrogen atoms, usually one alkene
...
alkyl halide with ẞ-hydrogen atoms when reacted with a base or a nucleophile has two
...
Similarly, a primary alkyl halide will prefer a S2 reaction, a secondary halide- S2 or
elimination depending upon the strength of base/nucleophile and a tertiary halide- S1 or
...
The sp² hybridised carbon with a greater s-character is more
electronegative and can hold the electron pair of C-X bond
more tightly than sp³-hybridised carbon in haloalkane with
...
by resonance and therefore, S₁1 mechanism is ruled out.
...
sodium hydroxide solution at a
...
The presence of an electron withdrawing group (-NO₂) at ortho- and

para-positions increases the reactivity of haloarenes.

рог temperature of 623K and a pressure
...
The effect is pronounced when (-NO₂) group is introduced at ortho-
...
Can you think why does NO₂ group show its effect only at ortho- and para- positions
...
stabilised by -NO₂ group while in case of meta-nitrobenzene, none of the resonating
...
Inductive effect destabilises the
...
Resonance effect stabilises the
intermediate carbocation
...
rapidly by an S2 mechanism? Explain your answer.

CH3

(i) CH3CH2CH2CH2Br or CH3CH2CHCH3

(ii) CH3CH2CHCH3 or HC HC-C-Br
...
6.8 In the following pairs of halogen compounds, compounds, which compound undergoes faster
...
corrosive and easily liquefiable gases. Freon 12 (CC12F2) is one of the
...
S1 and S2 on the basis of their kinetic properties. Chirality has a profound role in
understanding the reaction mechanisms of Sl and S2 reactions. S2 reactions of
chiral alkyl halides are characterised by the inversion of configuration while S1 reactions
...
(i) (CH3)2CHCH(Cl)CH3
(iii) CH₂CH₂C(CH3)2CH2I

(v) CH3CH(CH3)CH(Br)CH₃

(vii) CH3C(Cl)(C₂H₄)CH₂CH₂
(ix) CH3CH=CHC(Br)(CH₃)₂

(xi) m-ClCH₂CH₄CH₂C(CH3)3
...
(viii) CH3CH=C(Cl)CH2CH(CH₃)₂

(x) p-ClCHCH2CH(CH3)2

(xii) o-Br-CH4CH(CH3)CH2CH3

Give the IUPAC names of the following compounds:

(i) CH3CH(Cl)CH(Br)CH3 (ii) CHF2CBrC1F (iii) ClCH₂C=CCH2Br

6.3

(iv) (CCl3)3CCl (v) CH3C(p-ClC&H4)2CH(Br)CH3(vi) (CH3)3CCH=CCICHI-p
...
(i) CH₂Cl₂ (ii) CHCl(iii) CCl4

6.5

A hydrocarbon C5H10 does not react with chlorine in dark but gives a single
monochloro compound HCl in bright sunlight. Identify the hydrocarbon.

6.6

Write the isomers of the compound having formula HBr.
...
6.9 Which compound in each of the following pairs will react faster in S2 reaction

with OH?

(i) CHBr or CHI (ii) (CH3)3CCl or CHCI
...
6.17 Out of CH3CH2Cl and CHCHCICH, which is more easily hydrolysed by aqueous
...
Primary alkyl halide CHBr (a) reacted with alcoholic KOH to give compound (b).
...
(vi) methyl chloride is treated with_KCN?

Answers to Some Intext Questions

6.1

(i) CH3CH2CH(CH3)CHCICH3

6.2

6.3

(iii) CH3CH2CH, CH CH(I)CH2CH3
HC-C-CH
...
(i) H₂SO₄ cannot be used along with KI in the conversion of an alcohol to
an alkyl iodide as it converts KI to corresponding acid, HI which is then
oxidised by it to I.

(i) CICH2CH2CH2Cl (ii) ClCH2CHCICH (iii) Cl₂CHCH2CH3 (iv) CHCC1₂CH₂
...
(i) CH₂CH₂CH₂CH₂Br Being primary halide, there won't be any
...
of methyl group closer to the

group will increase the steric
