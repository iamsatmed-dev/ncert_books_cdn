# NCERT: 12TH_PHYSICS_CH13_NUCLEI_CH13_NUCLEI_EN
...
13.2 АтоMIC MASSES AND COMPOSITION OF NUCLEUS
...
atomic mass unit (u), defined as 1/12th of the mass of the carbon (¹2C)
...
example, the atomic mass of chlorine atom is 35.46 น.
...
Nuclear species or nuclides are shown by the notation X AX where X is
...
Deuterium, H, which is an isotope of hydrogen, contains one proton
and one neutron. Its other isotope tritium, H, contains one proton and
...
example, the nuclides and He are isobars. Nuclides with same
neutron number N but different atomic number Z, for example 198 Hg
and 197 Au, are called isotones.
...
of the nucleus, which is proportional to R³ is proportional to A. Thus the
...
matter is approximately 2.3 × 1017 kg m¯³. This density is very large
compared to ordinary matter, say water, which is 103 kg m³. This is
...
Here the energy equivalent of mass mis related by the above equation
...
Energy, E = 10-3 × ( 3 × 10)2 J

energy equivalent of 1 g of substance.

E = 10¯³ × 9 × 1016 = 9 × 1013 J
...
the nuclear mass Mis found to be always less than this. For example, let
us consider 0 ; a nucleus which has 8 neutrons and 8 protons. We
have

8

Mass of 8 neutrons = 8 × 1.00866 น

Mass of 8 protons = 8 × 1.00727 u

Mass of 8 electrons = 8 × 0.00055 น

Therefore the expected mass of O nucleus

= 8 × 2.01593 u = 16.12744 น.
...
The atomic mass of O found from mass spectroscopy experiments
is seen to be 15.99493 u. Substracting the mass of 8 electrons (8×0.00055 u)
from this, we get the experimental mass of ¹O nucleus to be 15.99053 u.

Thus, we find that the mass of the O nucleus is less than the total
...
For 10, AM = 0.13691 u = 0.13691×931.5 MeV/c²
...
The energy needed to separate O into its constituents is thus
...
in the process. The energy E₁ is called the binding energy of the nucleus.
...
energy per nucleon, Ebn, which is the ratio of the binding energy E of a
...
than ro, the force is attractive
and for separations less
than ro, the force is
strongly repulsive.
...
(i) a-decay in which a helium nucleus He is emitted;

(ii) ẞ-decay in which electrons or positrons (particles with the same mass
as electrons, but with a charge exactly opposite to that of electron)
are emitted;

energy (hu

(iii) y-decay in which high energy (hundreds of keV or more) photons are
emitted.
...
The fragment products are radioactive nuclei; they emit ẞ particles in
...
(3/2)k T = K z 400 keV, which gives T ~ 3 × 10° K.
...
Thus, four hydrogen atoms combine to form an He atom with a
...
10° K, fusion takes place again, this time of helium nuclei into carbon.
...
The age of the sun is about 5×10º y and it is estimated that there is
...
range of 10° K. At these temperatures, the fuel is a mixture of positive
...
2H₂ + O2→ 2 H₂O) is? If not, in what sense are they balanced on
both sides?
...
definition, 1 atomic mass unit (lu) is 1/12th mass of one atom of 12C;
...
is independent of A. It is of the order of 1017 kg/m³.
...
7. The nuclear mass M is always less than the total mass, Em, of its
...
The energy ∆Ε, represents the binding energy of the nucleus. In the
...
transform by giving out a or ẞor y rays; a-rays are helium nuclei;
ẞ-rays are electrons. y-rays are electromagnetic radiation of wavelengths
shorter than X-rays.

11. Energy is released when less tightly bound nuclei are transmuted into
more tightly bound nuclei. In fission, a heavy nucleus like 235 U breaks

99

92

into two smaller fragments, e.g., 235U+n →133 Sb + Nb + 4 n
...
varying, it shows peaks at nuclides like “He, 16O etc. This is considered
...
13.2 Obtain the binding energy of the nuclei 56 Fe and 209 Bi in units of
...
Cu atoms (of mass 62.92960 น).

13.4 Obtain approximately the ratio of the nuclear radii of the gold isotope

197 Au and the silver isotope 107 Ag.

to bevepubished

47

13.5 The value of a nuclear reaction A + b → C + d is defined by
...
13.6 Suppose, we think of fission of a 56 Fe nucleus into two equal
fragments, 28 Al. Is the fission energetically possible? Argue by
working out of the process. Given m (Fe) = 55.93494 u and
m (Al) = 27.98191 u.
...
13.7 The fission properties of 239 Pu are very similar to those of 235 U. The
average energy released per fission is 180 MeV. How much energy,
in MeV, is released if all the atoms in 1 kg of pure 239 Pu undergo
fission?
...
13.10 From the relation R = RA1/3, where R is a constant and A is the
mass number of a nucleus, show that the nuclear matter
