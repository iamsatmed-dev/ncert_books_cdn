# NCERT: 12TH_PHYSICS_CH02_ELECTROSTATIC_POTENTIAL_AND_CAPACITANCE_CH02_ELECTROSTATIC_POTENTIAL_AND_CAPACITANCE_EN
...
First, for simplicity, consider the field E due to a charge placed at the
...
that the test charge qis so small that it does not disturb
the original configuration, namely the charge at the
origin (or else, we keep fixed at the origin by some
...
Thus, work done by external forces in moving a charge q from R to Pis
...
force and hence work done by electric field is negative, i.e., –Wpp.)
...
Rat any point in a region with electrostatic field is
...
dq, obtain the work done 8W in bringing it from
infinity to the point and determine the ratio
8W/8q. Also, the external force at every point of the
...
charge Q (Q > 0), is the potential at
the charge Q.
...
This, by definition is the potential at P due to the charge
...
form infinity to the point Pis
...
Figure (2.4) shows how the electrostatic potential (x 1/r) and the
electrostatic field (x 1/r²) varies with r.

Example 2.1

(a) Calculate the potential at a point P due to a charge of 4 × 10¯°C
located 9 cm away.

charge of

(b) Hence obtain the work done in bringing a charge of 2 charge of 2 >
...
P the field falls off, at large distance, not as
1/r² (typical of field due to a single charge)
but as 1/r³. We, now, determine the electric
...
and r₂ are the distances of the

point P from qand –q, respectively.
...
a/rare negligible. For a point dipole p at the origin, Eq. (2.15) is, however,

exact.

From Eq. (2.15), potential on the dipole axis (0 = 0, π) is given by
...
(Positive sign for 0 = 0, negative sign for θ = π.) The potential in the
...
angle between the position vector rand the dipole moment vector p.
(It is, however, axially symmetric about p. That is, if you rotate the
position vector r about p, keeping e fixed, the points corresponding

to P on the cone so generated will have the same potential as at P.)

(ii) The electric dipole potential falls off, at large distance, as 1/r², not as
1/r, characteristic of the potential due to a single charge. (You can
refer to the Fig. 2.5 for graphs of 1/r² versus r and 1/r versus r,
...
charges q₂ and q3, respectively; and so on for the
potential due to other charges. By the
superposition principle, the potential Vat P due
...
density p (r), we divide it, as before, into small volume elements each of
size Au and carrying a charge p∆U. We then determine the potential due
...
where q is the total charge on the shell and Rits radius. The electric field
...
and, therefore, equals its value at the surface, which
is
...
(a) Give the signs of the potential difference VP-Vo; Vor
...
(a) As V × =, Vp> V. Thus, (Vp− Vo) is positive. Also V₁ is less negative

than Va. Thus, VB > VA or (VB – V₁) is positive.
...
Similarly, (P.E.) > (Р.Е.) and hence sign of potential energy
differences is positive.

(c) In moving a small positive charge from to P, work has to be
...
from or ending at the charge, depending on whether qis positive or negative.
...
Since 8V is negative, SV = – |6V|. we can rewrite
...
rection nonditsions concerning ished

(2.21)

We thus arrive at two important the relation
between electric field and potential:

(i) Electric field is in the direction in which the potent
...
where rip is the distance of a point P in space from the location of q₁.
...
q, brought later, the potential energy Uwould be the same.
...
Equation (2.22) is true for any sign of q₁and q2. If q1q2 > 0, potential
energy is positive. This is as expected, since for like charges (q₁q2 > 0),
...
charges q1, q2 and q3 located at r₁, r2, r3, respectively. To bring q₁ first
...
(ii) Work needed to bring –q to B when +q is_at A. This is given by
...
a potential difference of AV = 1 volt, it would gain energy of q∆V = 1.6 ×
10-19J. This unit of energy is defined as 1 electron volt or leV, i.e.,
1 eV=1.6 × 10~¯¹ºJ. The units based on eV are most commonly used in
atomic, nuclear and particle physics, (1 keV = 10°eV = 1.6 × 10-16J, 1 MeV
= 10eV = 1.6 × 10-13J, 1 GeV = 10°eV = 1.6 × 10-10J and 1 TeV = 1012eV
...
the field due to grey

Work done on q₂ against
...
have made use of Eqs.

where 12 is the distance between q₁ and
...
external electric field E = A (1/r²); A = 9 × 105 NC¯¹ m². What would
...
0 to angle 0, at an infinitesimal angular speed and
...
then associate potential energy U(0) with an inclination @ of the dipole.
...
choice is to take 0 = π / 2. (An explanation for it is provided towards the
end of discussion.) We can then write,

π

U (0) = pE cos PE(COS-COS)
...
displacement parallel to the force is 2a cose. Thus, [V(r₁)-V (r2)]
-Ex 2a cose. We thus obtain,
...
We note that U'(0) differs from U(0) by a quantity which is just a constant
...
We can now understand why we took 0=π/2. In this case, the work
done against the external field E in bringing +q and – q are equal and
opposite and cancel out, i.e., q[V(r₁) – V (r2)]=0.
...
of magnitude 106 V m¯¹. The direction of the field is suddenly changed
...
Solution Here, dipole moment of each molecules = 10-29 Cm
...
= 6 × 106 Cm
Initial potential energy, U₁ = −pE cos_0 = −6×10°º×10° cos 0° = −6 J
Final potential energy (when 0 = 60°), U₁ = −6 × 10^6 × 10° cos 60° = −3 J
...
where o is the surface charge density and n is a unit vector normal
...
of the pill box. This equals ± ESS (positive for σ> 0,
negative for σ < 0), since over the small area 8S, E
may be considered constant and E and 8S are parallel
...
distribution of a dielectric at the Non-polar
molecular level.
...
where X is a constant characteristic of the dielectric and is known as the
electric susceptibility of the dielectric medium.

It is possible to relate X to the molecular properties of the substance,
...
every volume element Au of the slab has a dipole moment
PAU in the direction of the field. The volume element Au is
macroscopically small but contains a very large number of
molecular dipoles. Anywhere inside the dielectric, the
volume element Au has no net charge (though it has net
...
and-6. Clearly, the field produced by these surface charges
...
±5 arises from bound (not free charges) in the dielectric.
...
Consequently, Vis also proportional to Q, and the
ratio Q/Vis a constant:
...
capacitance is 1 farad (=1 coulomb volt¯¹) or 1 F = 1 C V¯¹. A capacitor
with fixed capacitance is symbolically shown as ┫├, while the one with
variable capacitance is shown as #.

Equation (2.38) shows that for large C, Vis small for a given Q. This
means a capacitor with large capacitance can hold large amount of charge

at a relatively small V. This is of practical importance. High potential
...
strength; for air it is about 3 × 10º Vm¯¹. For a separation between
conductors of the order of 1 cm or so, this field corresponds to a potential
difference of 3 × 10^ V between the conductors. Thus, for a capacitor to
...
units are its sub-multiples 1 µF = 10¯° F, 1 nF = 10¯° F, 1 pF = 10-12 F,
...
them. The two plates have charges and -Q. Since
d is much smaller than the linear dimension of the
plates (d² << A), we can use the result on electric
...
charge density −6. Using Eq. (1.33), the electric field
...
edges an effect called 'fringing of the field'. By the same token, σwill
not be strictly uniform on the entire plate. [E and σ are related by Eq.
(2.35).] However, for d² << A, these effects can be ignored in the regions
...
typical values like A = 1 m², d = 1 mm, we get

C =

-2

8.85 × 10-12 C2N¯¹m¯2×1m²
...
charge on the plates is ±Q, corresponding to the charge density ±0 (with
...
and the potential difference Vis
Vo = Ed
...
densities and −6. The electric field in the dielectric then corresponds
to the case when the net surface charge density on the plates is ±(σ−
That is,
...
For linear dielectrics, we expect o to be proportional to E, i.e., to σ.
...
The product &K is called the permittivity of the medium and is

denoted by ɛ

ε = ε Κ

For vacuum K = 1 and ɛ =

The dimensionless ratio

(2.52)

ερ; & is called the permittivity of the vacuum.
...
from Eq. (2.49), it is clear that Kis greater than 1. From Eqs. (2.46) and
(2.51)
...
is now inserted, the electric field in the dielectric will be E = E/Κ.
...
capacitance C1, C2,..., C₁ to obtain a system with
...
follows that the right plate of C₁ has charge -Q
...
potential drop Vacross the combination is the sum of the potential drops
...
charge and potential difference V. The effective capacitance of the
combination is
...
(a) In the given network, C1, C2 and C₃ are connected in series. The
...
For C₁ = C2 = C3 = 10 µF, C' = (10/3) μF. The network has C' and C4
...
C₂ and C3 is the same, say Q. Let the charge on C₁ be Q'. Now, since
the potential difference across ABis_Q/C₁, across BC is Q/C2, across
...
Q = 500V × 10µF = 1.7×10-3C

-μF and

3

Q' = 500V × 10µF = 5.0×10-3 С

### 2.15 ENERGY STORED IN A CAPACITOR

A capacitor, as we have seen above, is a system of two conductors with
charge and –Q. To determine the energy stored in this configuration,
...
charge d' is transferred from conductor 2 to 1. Work
done in this step (8 W), resulting in charge Q' on
conductor 1 increasing to
...
The surface charge density ois related to the electric field Ebetween
...
Q = CV = 900 × 10-12 F × 100 V = 9 × 10-8 С

The energy stored by the capacitor is

= (1/2) CV2 = (1/2) QV

= (1/2) × 9 × 10¯°C × 100 V = 4.5 × 10-6 J
...
q from a point R to a point P_is_q(Vp-VR), which is the difference in
...
r due to a point charge placed at the origin is given is given by
...
### 4. For a charge configuration q1, q2, qn with position vectors r₁,
r2, ... r, the potential at a point P is given by the superposition principle
...
where r₁p is the distance between q₁ and P, as and so on.
...
energy of two charges q1, q2 at r₁, r₂ is given by
...
where r₁₂ is distance between q₁ and q2.
...
-n where n is the unit vector along the outward normal to the
surface and ois the surface charge density. Charges in a conductor can
...
capacitance is defined by C = C = Q/V, where Qand – are the charges on the
...
1 F = 1 CV¯¹. For a parallel plate capacitor (with vacuum between the
plates),
...
Co when there is no medium (vacuum),
...
12. The energy U stored in a capacitor of capacitance C, with charge and
voltage V is
...
strength the potential free touched may have considerable

capacitor is small.

### 3. Electric field is discontinuous across the surface of a spherical charged
shell. It is zero inside and 1 En outside. Electric potential is, however
continuous across the surface, equal to q/4πεR at the surface.
