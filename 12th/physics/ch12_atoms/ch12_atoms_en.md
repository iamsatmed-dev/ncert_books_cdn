# NCERT: 12TH_PHYSICS_CH12_ATOMS_CH12_ATOMS_EN
...
214 Bi radioactive source at a thin metal
...
being largely empty space, it is easy to see why most a-particles go right
through a thin metal foil. However, when a-particle happens to come
...
parameter, band scattering angle 0
...
to its mechanical energy E₁ when the a-particle momentarily stops.
...
7.7 MeV or 1.2 × 10-12 J. Since 1/4περ = 9.0 × 10º N m²/C². Therefore
with e = 1.6 × 10-19 C, we have,

d =

(2)(9.0×10º Nm² / C² )(1.6×10-1ºC)² Z
...
d (Au) = 3.0 × 10-14 m = 30 fm. (1 fm (i.e. fermi)
...
analyse the transmitted light Lyman
...
is 2.2 × 10 m/s. Thus, the frequency of the electron moving around
the proton is
...
where E and Eare the energies of the initial and final states and E₁> Ef.
...
energy equal to E₂ – E₁ = −3.40 eV – (–13.6) eV = 10.2 eV.
Similarly, E3 =−1.51 eV and E3 – E₁ = 12.09 eV, or to excite
...
nergy state corresponds to n =∞ in Eq, (12.10) and has an energy
of 0 eV. This is the energy of the atom when the electron is
completely
removed (r = x) from the nucleus and is at rest. Observe how
...
energy is carried away by a photon of frequency v₁₁ such that
...
12.6 DE BROGLIE'S EXPLANATION OF N OF BOHR'S
...
the nucleus is quantised (that is, L₁ = nh/2π; n = 1, 2, 3 ...).
Why should the angular momentum have only those values
that are integral multiples of h/2π? The French physicist Louis
...
for n = 4, i.e., 2πr = 4λ, where i is the de Broglie wavelength of the electron
moving in nth orbit. From Chapter 11, we have λ = h/p, where p is the
magnitude of the electron's momentum. If the speed of the electron is
much less than the speed of light, the momentum is mv. Thus, λ = h/
...
That is L = nh/2π, wheren is an integer called the principal
quantum number.
...
frequency (v) of the emitted photon is then given by
...
8. de Broglie's hypothesis that electrons have a wavelength λ = h/mvgave
...
electrons are in stable equilibrium,
...
of the gold foil. (Hydrogen is a solid at temperatures below 14 Κ.)
...
of radius 1.5 × 10¹¹ m with orbital speed 3 × 104 m/s. (Mass of earth
= 6.0 × 1024 kg.)
