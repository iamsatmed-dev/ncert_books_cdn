# NCERT: 12TH_PHYSICS_CH01_ELECTRIC_CHARGES_AND_FIELDS_CH01_ELECTRIC_CHARGES_AND_FIELDS_EN
> **Total Pages**: 44 | **Digitized via**: Google Document AI OCR
...
no longer attract each other. They also do not attract or or repel other light
...
a system contains two point charges q₁ and q₂, the total
charge of the system is obtained simply by adding
algebraically q₁ and q₂ , i.e., charges add up like real numbers or they
are scalars like the mass of a body. If a system contains n charges q₁,
q2, q3, ………, qn, then the total charge of the system is q₁ + q₂ + q3 + ... + qn
...
and hence we use smaller units 1 µC (micro coulomb) = 10¯° C or 1 mC
(milli coulomb) = 10¯³ C.
...
Thus, if a body contains n₁ electrons and n₂ protons, the total amount
of charge on the body is n₂ × e + n₁ × (-e) = (n₂ – n₁) e. Since n₁ and n₂
...
of magnituOde, say 1 µC, contains something like 1013 times the electronic
...
Example 1.1 If 10º electrons move out of a body to another body
every second, how much time is required to get a total charge of 1 C
on the other body?

Solution In one second 10º electrons move out of the body. Therefore
the charge given out in one second is 1.6 × 10-19 × 10° C = 1.6 × 10-10 C.
The time required to accumulate a charge of 1 C can then be estimated
to be 1 C ÷ (1.6 × 10-10 C/s) = 6.25 × 10º s = 6.25 × 10° ÷ (365 × 24 ×
3600) years = 198 years. Thus to collect a charge of one coulomb,
from a body from which 10° electrons move out every second, we will
...
(250/18) × 6.02 × 1023 × 10 × 1.6 × 10-19 C = 1.34 × 107 С.
...
point charges q1, q₂ are separated by a distance r in vacuum,
...
9 × 10º N. One coulomb is evidently too big a unit to
be used. In practice, in electrostatics, one uses
smaller units like 1 mC or 1 µC.

The constant k in Eq. (1.1) is usually put as
k = 1/4περ for later convenience, so that Coulomb's
law is written as
...
8 = 8.854 × 10-12 C2 N¯¹m-2

Since force is a vector, it is better to write
Coulomb's law in the vector notation. Let the position
vectors of charges q₁ and q₂ be r₁ and r₂ respectively
[see Fig.1.3(a)]. We denote force on q₁ due to q₂ by
F12 and force on q₂ due to q₁ by F21. The two point
charges q₁ and q₂ have been numbered 1 and 2 for
...
eading from 2 to 1 is denoted by r12:

121 and 12 is denoted by r21 and 112,
...
Coulomb's force law between two point charges q₁ and q, located at

r₁ and r2, respectively is then expressed as
...
Equation (1.3) is valid for any sign of q₁ and q₂ whether positive or
negative. If q₁ and q₂ are of the same sign (either both positive or both
negative), F21 is along ŕ 21, which denotes repulsion, as it should be for
like charges. If q₁ and q₂ are of opposite signs, F21 is along-r21 (= r 12),
...
The force F12 on charge q₁ due to charge q₂, is obtained from Eq. (1.3),
...
Coulomb's law [Eq. (1.3)] gives the force between two charges q₁ and
...
mutual attraction when they are 1 Å (= 10-10 m) apart? (mp

10-27 kg, m = 9.11 × 10-31 kg)
...
where m, and mare the masses of a proton and an electron
...
between two protons is ~ 10-15 m inside a nucleus) are F ~ 230 N,
whereas, F1.9 × 10~34 N.
...
### 2.3 × 10¯° N / 1.67 × 10-27 kg = 1.4 × 1019 m/s²
...
Solution Let the original charge on sphere A be qand that on B be
q'. At a distancer between their centres, the magnitude of the
...
system of n stationary charges q1, q2, q3, ..., qm in vacuum.
What is the force on q₁ due to q2, q3, ..., q„? Coulomb's law is
...
due to q₂ is denoted by F12, F12 is given by Eq. (1.3) even
...
In the same way, the force on q₁ due to q3, denoted by F13, is given by
...
which again is the Coulomb force on q₁ due to q3, even though other
charge q₂ is present.

Thus the total force F₁ on q₁ due to the two charges q₂ and q3 is
given as
...
q2, ..., qn, the force on q₁ due to q₂ is the same as given by Coulomb's law,
i.e., it is unaffected by the presence of the other charges q3, A4, qn. The
total force F₁ on the charge q₁, due to all other charges, is then given by
the vector sum of the forces F12, F13, ..., Fin
...
Force F₁ on due to charge q at A

=

Force F₂ on due to charge q at B
...
Force Fon due to charge q at C
...
The resultant of forces F₂ and F3 is

2

4πεο 12 along OA, by the
...
= 0, where r is the unit vector along OA.
...
Solution The forces acting on charge qat A due to charges qat B
and –q at C are F12 along BA and F13 along AC respectively, as shown
in Fig. 1.7. By the parallelogram law, the total force F₁ on the charge
qat A is given by

F₁ = Fr, where ŕ is a unit vector along BC.
...
Similarly the total force on charge –q at C is F3 = √3 Fń, where nis
...
When another charge qis brought at some point P, the field there acts on
...
where ŕ = r/r, is a unit vector from the origin to the point r. Thus, Eq.(1.6)
...
Note that the charge qalso exerts an equal and opposite force on the
...
Qand vice versa. If we denote the position of charge q by the vector r, it
...
a charge is numerically equal to the force exerted by it. Thus, the
...
A practical way to get around the problem (of keeping
in the presence of q) is to hold to its location by unspecified forces!
...
the charge Q. Thus, the electric field E due to is also dependent on
the space coordinate r. For different positions of the charge qall over
...
depends only on the distancer of the charge q from charge Q,
...
Consider a system of charges q1, q2, …, q₁ with position vectors r₁,
Γ2, ..., r relative to some origin O. Like the electric field at a point in
...
positions of charges q1, q2, ..., qħ. We can use Coulomb's law and the
...
where îp is a unit vector in the direction from q₁ to P,

and r₁p is the distance between q₁ and P.

In the same manner, electric field E₂ at r due to q₂ at
r₂ is
...
where 12p is a unit vector in the direction from q₂ to P
and r2p is the distance between q₂ and P. Similar
expressions hold good for fields E3, E4, ..., E, due to
charges q3, 94, ..., qn
...
between two distant charges q1, q₂ in accelerated motion. Now the greatest
...
(force on q₂) and the cause (motion of q₁). It is precisely here that the
...
c, reach q₂ and cause a force on q₂. The notion of field elegantly accounts
...
For e = 1.6 × 10¯¹ºC, m = 9.11 × 10-31 kg,

E = 2.0 × 10^ N C¯¹, h = 1.5 × 102 m,
t = 2.9 × 10¯ºs
...
(1.6 × 10-19 C) × (2.0 × 104 NC¯¹)

### 1.67 × 10-27 kg

= 1.9 × 1012 ms-2

which is enormous compared to the value of
...
porto be re in apart. Calculate the electric
...
q₁ points towards the right and has a magnitude
...
The electric field vector E2A at A due to the negative charge q₂ points
towards the right and has the same magnitude. Hence the magnitude
of the total electric field E at A is

EA = ELA + E2A = 7.2 × 104 N C¯¹
...
The electric field vector E1B at B due to the positive charge q₁ points
...
The electric field vector E2B at B due to the negative charge q₂ points
...
can imagine two equal and small elements of area placed at points Rand
...
these points. The picture shows that the field at Ris stronger than at S.
...
transverse line element Al be placed at a distance r from a point O. Then
the angle subtended by Al at O can be approximated as A0 = Al/r.
Likewise, in three-dimensions the solid angle* subtended by a small
perpendicular plane area AS, at a distance r, can be written as
ΔΩ = ∆S/r². We know that in a given solid angle the number of radial
field lines is the same. In Fig. 1.13, for two points P₁ and P₂ at distances
r₁ and r₂ from the charge, the element of area subtending the solid angle
ΔΩ is r² ΔΩ at P₁ and an element of area r2 ΔΩ at P2, respectively. The
number of lines (say n) cutting these area elements are the same. The
number of field lines, cutting unit area element is therefore n/(r² ΔΩ) at
P₁ and n/(r2 ΔΩ) at P₂, respectively. Since n and ΔΩ are common, the
strength of the field clearly has a 1/r² dependence.
...
to AS/R², where AS is the area on the sphere cut out by the cone.
...
area per unit time udSand represents the flux of liquid
flowing across the plane. If the normal to the surface is
not parallel to the direction of flow of liquid, i.e., to v, but
makes an angle @ with it, the projected area in a plane
perpendicular to vis & dS cos 0. Therefore, the flux going
out of the surface dS is v. n dS. For the case of the electric
...
we place a small planar element of area AS
normal to E at a point, the number of field lines
crossing it is proportional* to E AS. Now
suppose we tilt the area element by angle 0.
Clearly, the number of field lines crossing the
area element will be smaller. The projection of
the area element normal to E is AS cose. Thus,
the number of field lines crossing AS is
proportional to E∆S cose. When 0 = 90°, field
...
in Fig. 1.16. Thus, the area element vector AS at a point on a closed
surface equals AS ń where AS is the magnitude of the area element and
ń is a unit vector in the direction of outward normal at that point.

We now come to the definition of electric flux. Electric flux A through
...
the area element. The angle @ here is the angle between E and ∆S. For a
closed surface, with the convention stated already, is the angle between
E and the outward normal to the area element. Notice we could look at
the expression E AS cose in two ways: E (AS cose) i.e., E times the

*

It will not be proper to say that the number of field lines is equal to EAS. The
...
projection of area normal to E, or E AS, i.e., component of E along the
normal to the area element times the magnitude of the area element. The
unit of electric flux is N C-1 m².
...
flux at each element and add them up. Thus, the total flux & through a
surface Sis
...
only when you take the limit AS → 0 and the sum in Eq. (1.12) is written
as an integral.
...
be the direction of the dipole. The mid-point of locations of –q and qis
called the centre of the dipole.

The total charge of the electric dipole is obviously zero. This does not
mean that the field of the electric dipole is zero. Since the charge qand
...
therefore falls off, at large distance, faster than like 1/r² (the dependence
...
fields Eq due to the charge -–q and E+q due to the charge q, by the
...
at (a) a point on the axis, (b) a point The directions

-q

E+q and E are as shown in
...
add up. The total electric field is opposite to p. We have
...
falls off not as 1/r² but as1/r³. Further, the magnitude and the direction
...
field. Such molecules are called polar molecules. Water molecules, H₂O,
...
4π (8.854×10-12 C2 N¯¹ m¯²)^^ (15−0.25)²×10¯4 m²
...
4π(8.854×10-12 C2 N-1 m-2) (15 +0.25)² ×10-4 m²

### 3.86 × 10° N C¯¹ along PA
...
field at a distancer from the centre on the axis of the dipole has a
magnitude
...
4 π (8.854 × 10-12 C2 N-1 m-2) [15² + (0.25)²] × 104 m²

= 3.99 × 10º N C¯¹ along BQ

Field at

Field at due to charge -10 µC at A

1

= 4π(8.854×10-12 C² N¯¹ m¯²)^ [15²+(0.25)²]×10¯*m²
...
to BA. Therefore, the resultant electric field at
...
× 3.99 × 10°N C¯¹ along BA

= 2 x

=

### 1.33 × 105 NC¯¹ along BA.
...
Magnitude of torque = q E × 2 a sine
...
The magnitude of p × E is also p E sine and its direction
...
91, 92, ..., q. One reason why we restricted to discrete charges is that the
...
constituents. It is more feasible to consider an area element AS (Fig. 1.21)
...
specify the charge AQ on that element. We then define a surface charge
density o at the area element by
...
average of the microscopic charge density over an area element AS which,
...
charge distribution. The linear charge density i of a wire is defined by
ΔΩ
λ =
Δι
...
where Al is a small line element of wire on the macroscopic scale that,
however, includes a large number of microscopic charged constituents,
and AQ is the charge contained in that line element. The units for a are
...
where AQ is the charge included in the macroscopically small volume
element AV that includes a large number of microscopic charged
constituents. The units for pare C/m³.
...
a continuous charge distribution in space has a charge density p. Choose
any convenient origin O and let the position vector of any point in the
charge distribution be r. The charge density p may vary from point to
point, i.e., it is a function of r. Divide the charge distribution into small
volume elements of size AV. The charge in a volume element AV is PAV.

Now, consider any general point P (inside or outside the distribution)
with position vector R (Fig. 1.21). Electric field due to the charge PAV is
...
where r' is the distance between the charge element and P, and ŕ' is a
...
charge q. The unit vector ŕ is along the radius vector from the centre to
the area element. Now, since the normal to a sphere at every point is
along the radius vector at that point, the area element AS and ŕ have
...
flux & through the surface is_¢ = Φ₁ + Φ2 + ¢3, where ¢₁ and ¢₂ represent
the flux through the surfaces 1 and 2 (of circular cross-section) of the
cylinder and is the flux through the curved cylindrical part of the
closed surface. Now the normal to the surface 3 at every point is
perpendicular to E, so by definition of flux, ф₃ = 0. Further, the outward
...
perpendicular to x direction, the angle between E and AS is
± π/2. Therefore, the flux 4 = E.∆S is separately zero for each face
...
Φ₁= ELAS = ASE₁· ń₁=E₁ AS cos0 = −E₁ AS, since 0 = 180°

= -E₁a²

R= ERAS = ER AS cose = ER AS, since 0 = 0°
...
ΦR+ Φ₁ = Ερα² – Ε₁a² = a² (Er− E₄) = αα² [(2a)1/2 – a1/2]
...
the negative x direction for negative x. It is given that E = 200 í N/C
...
(a) We can see from the figure that on the left face E and AS are

parallel. Therefore, the outward
...
AS and hence E.AS = 0. Therefore, the flux out of the side of the
cylinder is zero.

(c) Net outward flux through the cylinder

φ= 1.57 + 1.57 + 0 = 3.14 N m² C¯¹
...
Consider a pair of line elements P₁ and P₂
...
and hence the total field at any point Pis
...
of the curved part is 2arl, where lis the length
of the cylinder.
...
where n is the radial unit vector in the plane normal to the wire passing
through the point. E is directed outward if a is positive and inward if a is
negative.
...
is in the +x direction. Therefore, flux E.AS through
...
where ń is a unit vector normal to the plane and going away from it.

E is directed away from the plate if o is positive and toward the plate
if o is negative. Note that the above application of the Gauss' law has
...
E × 4 πr². However, in this case, the Gaussian surface encloses no
...
(i) r < R : The electric flux o enclosed by the spherical surface is
φ = Ε (r) × 4πr²
...
Substituting for the charge density pobtained earlier, we have
...
Proton and electron have charges
...
charges q₁ and q₂ is proportional to the product q₁₂ and inversely
proportional to the square of the distance r21 separating them.
Mathematically,

k (q192)

F21 = force on q₂ due to q₁ =
...
where 21 is a unit vector in the direction from q₁ to q₂
...
The approximate value of kis

ερ = 8.854 × 10-12 C2 N-1 m-2
...
an assembly of charges q1, q2, q3, ..., the force on any charge, say q₁, is
the vector sum of the force on q₁ due to q₂, the force on q₁ due to q3,
...
a magnitude |q|/4πɛr²; it is radially outwards from q, if q is positive,
...
The 1/r³ dependence of dipole electric fields should be noted in contrast

to the 1/r2 dependence of electric field due to a point charge.

13. In a uniform electric field E, a dipole experiences a torquet given by
...
14. The flux Aq of electric field E through a small area element AS is
given by
...
where AS is the magnitude of the area element and n is normal to the
area element, which can be considered planar for sufficiently small AS.

For an area element of a closed surface, n is taken to be the direction
of outward normal, by convention.

15. Gauss's law: The flux of electric field through any closed surface S is
1/8 times the total charge enclosed by S. The law is especially useful
...
ń is the radial unit vector in the plane normal to the wire passing
...
the configuration, its field falls off faster than 1/r², typical of field
...
Two point charges q₁ = 3 µC and qB = −3 µC are located 20 cm apart
...
(b) If a negative test charge of magnitude 1.5 × 10¯º C is placed at
this point, what is the force experienced by the test charge?
A system has two charges q₁ = 2.5 × 107־ C and q = -2.5 × 10-7 С
...
### 1.10 An electric dipole with dipole moment 4 × 10¯º Cm is aligned at 30°
...
electrostatic repulsion if the charge on each is 6.5 × 107־ C? The
...
### 1.14 Consider a uniform electric field E = 3 × 10³ î N/C. (a) What is the
...
box is 8.0 × 103 Nm²/C. (a) What is the net charge inside the box?
...
### 1.18 A point charge of 2.0 µC is at the centre of a cubic Gaussian
surface 9.0 cm on edge. What is the net electric flux through the
surface?

### 1.19 A point charge causes an electric flux of −1.0 × 103 Nm²/C to pass
...
surface charge density of 80.0 µC/m². (a) Find the charge on the
...
signs and of magnitude 17.0 × 10-22 C/m². What is E: (a) in the outer
