# NCERT: 12TH_PHYSICS_CH09_RAY_OPTICS_AND_OPTICAL_INSTRUMENTS_CH09_RAY_OPTICS_AND_OPTICAL_INSTRUMENTS_EN
...
in vacuum is c = 2.99792458 × 10º m s¯¹. For many purposes, it suffices
to take c = 3 × 10º m s¯¹. The speed of light in vacuum is the highest
...
For small 0, which is true for paraxial rays, tan0 ≈ 0,
tan 20≈ 20. Therefore, Eq. (9.1) gives
...
Now, for small 0, the point D is very close to the point
Therefore, FD = fand CD = R. Equation (9.2) then gives
f = R/2
...
to travel opposite to the direction of incident sident light. Hence, all the three
...
hand h' will be taken positive or negative in accordance with the accepted
...
The image is 30 cm from the mirror on the as the

----30)=-3 te side

υ

Also, magnification m = u (-10)
...
This image is formed It is a virtual image.
...
the jogger is running at a speed of 5 m s¯¹, how fast the image of the
jogger appear to m move when the jogger is (a) 39 m, (b) 29 m, (c) 19 m,
and (d) 9 m away.
...
The shift in the position of image in 1sis
...
39 m and 34 m from the mirror, is (1/280) m s¯¹
...
similar phenomenon could be observed if the vehicle in the the rear is
...
respect to medium 1 and n₁₂ the refractive index
...
n31 X n12, where n31 is the refractive index of
...
that r₂ = i₁, i.e., the emergent ray is parallel to the
...
that the apparent depth (h₁) is real depth (h₂) divided by the refractive
...
say ∠AO3N, is called the critical angle (i ) for the given pair of media. We
...
ris unity, there is an upper limit to the value of sin i for which the law
can be satisfied, that is, i = i such that

sin i = n21

(9.12)

For values of i larger than i, Snell's law of refraction cannot be
satisfied, and hence no refraction is possible.

The refractive index of denser medium 1 with respect to rarer medium
2 will be n₁₂ = 1/sini. Some typical critical angles are listed in Table 9.1.
...
Now, for ∆ΝΟC, iis the exterior angle. Therefore, i
= ∠NOM + ∠NCM
...
u = – 100 cm, v = ?, R = + 20 cm, n₁ = 1, and n₂ = 1.5.
...
that case R₁is negative, R₂ positive and
therefore, fis negative.

Note that now the refractive index of the medium on the right side of ADC is n₁
...
appear to meet). In practice, however, it is convenient to choose any
of the following rays:
...
centre of the lens, emerges without any Object
...
image formed by a convex or concave lens, mis positive, while for an
inverted (and real) image, mis negative.
...
make the lens disappear. This means n₁ = n2. This gives 1/f =0 or
...
The SI unit for power of a lens is dioptre (D): 1D = 1m¯¹. The power of
...
(iii) For a glass lens in air, n₂ = 1.5, n₁ = 1, f = +20 cm. Hence, the lens
formula gives
...
combination is a product of magnification (m₁, m2, m3,………) of individual
...
the second face AC is r₂ and the angle of refraction
...
FIGURE 9.22 Plot of angle of deviation (8)
...
The angles A and D can be measured experimentally. Equation
(9.38) thus provides a method of determining refractive index of the
material of the prism.

m

For a small angle prism, i.e., a thin prism, D is also very small, and
we get
...
Now according to our sign convention, u is negative, and is equal in
...
Since Dis about 25 cm, to have a magnification of six, one needs a convex
lens of focal length, f = 5 cm.

Note that m = h'/h where his the size of the object and h' the size of
...
We now find the angle angle subtended at the eye by the image when the
...
≈0. The angle subtended by the object, when it
...
(focal length f) is called the tube length of the compound microscope.
...
obtain the (angular) magnification m due to it [Eq. (9.39)], when the
...
((c) magnification of anne

(9.45)

Clearly, to achieve a large magnification of a of a small object (hence the
...
For example, with an objective with f = 1.0 cm, and an eyepiece with
focal length f = 2.0 cm, and a

m=mm = length of 20 cm, the magnification is
◎ 
JoJoe length
...
producing a final inverted image. The magnifying power mis the ratio of
the angle ẞ subtended at the eye by the final image to the angle a which
...
### 1. Reflection is governed by the equation Zi = ∠r' and refraction by the
...
### 2. The critical angle of incidence i for a ray incident from a denser to rarer
...
where u and v are object and image distances, respectively and fis the
...
### 5. For a prism of the angle A, of refractive index n₂ placed in a medium
...
refractive index n₁ and n₂, respectively)
...
R₁ and R₂ are the radii of curvature of the lens surfaces. fis positive
for a converging lens; fis negative for a diverging lens. The power of a
lens P= 1/f.

The SI unit for power of a lens is dioptre (D): 1 D = 1 m¯¹.
...
where D = 25 cm is the least distance of distinct vision and fis the
focal length of the convex lens. If the image is at infinity, m = D/f. For
a compound microscope, the magnifying power is given by m = m × m
where m = 1 + (D/f), is the magnification due to the eyepiece and m。
...
where f and fe are the focal lengths of the objective and eyepiece,
respectively, and L is the distance between their focal points.

ded

9. Magnifying power m of a telescope is the ratio of the angle ẞ subtended
...
### 2. The real image of an object placed between fand 2f from a convex lens
...
9.10 What is the focal length of a convex lens of focal length 30cm in
...
diameter of the moon is 3.48 × 10°m, and the radius of lunar
orbit is 3.8 × 10°m.
...
and the convex lens is 40cm. Determine the magnification
...
9.22 A card sheet divided into squares each of size 1 mm² is being viewed
at a distance of 9 cm m through a magnifying glass (a converging lens
...
the figure is to have an area of 6.25 mm². Would you be able to
