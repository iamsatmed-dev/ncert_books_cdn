# NCERT: 12TH_BIOLOGY_CH05_MOLECULAR_BASIS_OF_INHERITANCE_CH05_MOLECULAR_BASIS_OF_INHERITANCE_EN
...
have learnt the inheritance

In the previous chapter, you
patterns and the
of such patterns. At the
...
For example, a bacteriophage known as $×174 has 5386 nucleotides,
Bacteriophage lambda has 48502 base pairs (bp), Escherichia coli has
4.6 × 106 bp, and haploid content of human DNA is 3.3 × 10º bp. Let us
...
or RNA). A nucleotide has three components
...
In a series of experimple was cated
...
### 5.2.1 The Genetic Material Material is DNA
...
nucleotides in a very short time. E. coli that has only 4.6 × 10º bp (compare
it with human whose diploid content is 6.6 × 10º bp), completes the
...
DNA replication results into polyploidy(a synthesis
...
polymerisation in only one direction, that is, 5'-8', the strand that has
the polarity 3'-5' acts as a template, and is also referred to as template
strand. The other strand which has the polarity (5'-8') and the sequence
...
and three structural genes (z, y, and a). The igene codes for the repressor
...
permease, which increases permeability of the cell to ẞ-galactosides. The
...
Human genome is said to have approximately 3 x 10º bp, and if the
...
humans is the same. Assuming human genome as 3 × 10º bp, in how
...
Amplified repeats, separated by size
on a gel, give a DNA fingerprint

Number of stort tandem repeats
...
Write down the sequence of complementary strand in 5'-8' direction.
...
and the nature of nucleic acids synthesised from it (DNA or or 
