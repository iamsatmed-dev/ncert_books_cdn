# NCERT: 12TH_BIOLOGY_CH07_HUMAN_HEALTH_AND_DISEASE_CH07_HUMAN_HEALTH_AND_DISEASE_EN
...
infection. The vaccines also generate memory – Band T-cells that recognise
...
NOTE: Infected cell can an survive while viruses are being
...
factory. Simultaneously, HIV enters into helper T-lymphocytes (T₁), replicates
...
loss. Due to decrease in the number of helper Tlymphocytes, the person starts
...
since then, the infection may spread to many more people.
