# NCERT: 12TH_BIOLOGY_CH09_BIOTECHNOLOGY_PRINCIPLES_AND_PROCESSES_CH09_BIOTECHNOLOGY_PRINCIPLES_AND_PROCESSES_EN
...
the same on the two strands in 5'→ 3' direction. This is also true if
...
Figure 9.3 A typical agarose gel
...
sed to UV light (Figure 9.3). The
...
an enzyme, ẞ-galactosidase. This results into inactivation of the
...
ẞ-galactosidase gene and the colonies do not produce any colour,
...
When you insert a piece of alien DNA into a cloning cloning vector and transfer it
