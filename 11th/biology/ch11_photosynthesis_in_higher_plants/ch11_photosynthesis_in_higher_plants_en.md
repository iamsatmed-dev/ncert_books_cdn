# NCERT: 11TH_BIOLOGY_CH11_PHOTOSYNTHESIS_IN_HIGHER_PLANTS_CH11_PHOTOSYNTHESIS_IN_HIGHER_PLANTS_EN
...
Photosynthesis in Higher period of time, ended up as two, apparently irreconcilable perspectives
...
by labelling the carbon dioxide with C¹4. Calvin proposed that
...
that chlorophyll (green pigment of the leaf), light and CO₂ are required for

11.9 Photorespiration photosynthesis to occur.
...
absorbs CO₂), while the other half is exposed to air.
...
negative. This showed that CO₂ was required for
...
to make carbohydrates from CO₂ and water. The empirical equation
...
In green plants H₂O is the hydrogen donor and is oxidised to O2. Some
organisms do not release O₂ during photosynthesis. When H₂S, instead
...
and not O2. Hence, he inferred that the O₂ evolved by the green plant
comes from H₂O, not from carbon dioxide. This was later proved by using
...
11.4 HoW MANY TYPES OF PIGMENTS ARE
...
(c) Wavelength of light in nanometres (nm)
...
with photosynthesis. But by looking at Figure Figure 11.3b Graph showing action

11.3c can you say that there is a complete one-
to-one overlap between the absorption
...
spectrum of photosynthesis
Figure 11.3c Graph showing action
spectrum of photosynthesis
...
reaction. The LHC are made up of hundreds of
...
hence is called P700, while in PS II it has absorption maxima at 680
...
to NADPH + H+. This whole scheme of transfer
...
H+ is called the Z scheme, due to its characterstic shape (Figure 11.5).
...
reducing it to Nar scheme of tested

Figure 11.5 Z reaction
...
membrane of the thylakoid. Then, where are the protons and O₂formed
...
series, first PS II and then the PSI, a process called
...
channel of the CF of the ATP synthase. The ATP synthase enzyme consists
of two parts: one called the CF is embedded in the thylakoid membrane
and forms a transmembrane channel that carries out facilitated diffusion
of protons across the membrane. The other portion is called CF₁ and
...
energy to cause a conformational change in the CF, particle of the ATP
...
the stroma, responsible for fixing CO₂, and synthesis of sugars.
...
these O, diffuses out of the chloroplast while ATP and NADPH are used to
...
phase. We saw earlier that CO, is combined with H₂O to produce (CH₂O)円
or sugars. It was of interest to scientists to find out how this reaction
proceeded, or rather what was the first product formed when CO₂ is taken
...
studies led to the discovery that the first CO₂ fixation product was a
...
product of CO2 fixation, or whether any other product was formed in
...
CO, fixation was again an organic acid, but one which had 4 carbon
atoms in it. This acid was identified to be oxaloacetic acid or OAA. Since

then CO₂ assimilation during photosynthesis was said to be of two main
types: those plants in which the first product of CO2 fixation is a C3 acid
(PGA), i.e., the C₃ pathway, and those in which the first product was a C₁
acid (OAA), i.e., the C₁ pathway. These two groups of plants showed
...
would a molecule have which after accepting (fixing) CO₂, would have 3
carbons (of PGA)?
...
They also believed that since the first product was a C₃ acid, the primary
...
where CO₂ is utilised for the carboxylation of RuBP. This reaction is
...
Figure 11.8 The Calvin cycle proceeds in three stages : (1) carboxylation, during which
CO₂ combines with ribulose-1,5-bisphosphate; (2) reduction, during which
carbohydrate is formed at the expense of the photochemically made ATP
and NADPH; and (3) regeneration during which the CO, acceptor ribulose-
...
phosphorylation and two of NADPH for reduction per CO₂ molecule
fixed. The fixation of six molecules of CO2 and 6 turns of the cycle are
required for the formation of one molecule of glucose from the pathway.

### 3. Regeneration – Regeneration of the CO₂ acceptor molecule RuBP is
...
Hence for every CO₂ molecule entering the Calvin cycle, 3 molecules
...
adapted to dry tropical regions have the C. path ished
...
Plants that are 
mentioned earlier. Though these plants have the C₁ oxaloacetic acid as
the first CO₂ fixation product they use the C3 pathway or the Calvin cycle
...
C₁ plants are special: They have a special type of leaf anatomy, they
...
Study vertical sections of leaves, one of a C3 plant and the other of a C₁
...
section of the leaves of C₁ plants – maize or sorghum – to observe the
...
The primary CO₂ acceptor is a 3-carbon molecule phosphoenol
...
to register that the mesophyll cells lack RuBisCO enzyme. The C₁ acid
...
sheath cells. In the bundle sheath cells these C₁ acids are broken down
...
The CO₂ released in the bundle sheath cells enters the C or the Calvin
...
cells of the C3 plants? In the C₁ plants it does not take place in the
...
difference between C3 and C₁ plants – Photorespiration. To understand
photorespiration we have to know a little bit more about the first step of
the Calvin pathway – the first CO₂ fixation step. This is the reaction
where RuBP combines with CO₂ to form 2 molecules of 3PGA, that is
...
both CO2 and O₂ – hence the name. Can you think how this could be
possible?RuBisCO has a much greater affinity for CO₂ when the CO₂: O₂
is nearly equal. Imagine what would happen if this were not so! This
binding is competitive. It is the relative concentration of O₂ and CO2 that
...
In C3 plants some O₂ does bind to RuBisCO, and hence CO₂ fixation is
decreased. Here the RuBP instead of being converted to 2 molecules of
PGA binds with O₂ to form one molecule of phosphoglycerate and
...
In C₁ plants photorespiration does not occur. This is because they
have a mechanism that increases the concentration of CO2 at the enzyme
site. This takes place when the C₁ acid from the mesophyll is broken
...
Now that you know that the C₁ plants lack photorespiration, you
...
Based on the above discussion can you compare plants showing the
C3 and the C₁ pathway? Use the table format given in table 11.1 and fill
...
TABLE 11.1 Fill in the Columns 2 and 3 in this table to highlight the differences
...
Which is the primary CO₂ acceptor
...
present at low CO, concentrations
Whether photorespiration would be
present at high CO, concentrations
...
chloroplasts, internal CO₂ concentration and the amount of chlorophyll.
...
temperature, CO, concentration and water. As a plant photosynthesises,
all these factors will simultaneously affect its rate. Hence, though several
factors interact and simultaneously affect photosynthesis or CO₂ fixation,
...
leaf and optimal light and CO₂ conditions, the
plant may not photosynthesise if the
...
except for plants in shade or in dense forests, light Figure 11.10 Graph of light intensity on the
...
concentration of CO₂ is very low in the atmosphere (between 0.03 and
0.04 per cent). Increase in concentration upto 0.05 per cent can cause an
increase in CO₂ fixation rates; beyond this the levels can become damaging
over longer periods.
...
The C3 and C₁ plants respond differently to CO₂ concentrations. At
low light conditions neither group responds to high CO₂ conditions. At
high light intensities, both C3 and C₄ plants show increase in the rates of
photosynthesis. What is important to note is that the C₁ plants show
saturation at about 360 µlL-1 while C3 responds to increased CO₂
...
The fact that C3 plants respond to higher CO₂ concentration by
...
much lesser extent. The C₁ plants respond to higher temperatures and
...
the CO2 availability. Besides, water stress also makes leaves wilt, thus,
...
of the protons gradient due to movement through the Fo part of the ATPase enzyme
...
In the carbon fixation cycle, CO₂ is added by the enzyme, RuBisCO, to a 5-
...
Some tropical plants show a special type of photosynthesis called C₁ pathway.
...
out for the synthesis of

kin Orbohydrates.

EXERCISES

### 1. By looking at a plant externally, can you tell whether a plant is C₃ or C₄? Why

and how?

### 2. By looking at which internal structure of a plant you can tell whether a plant is
C3 or C₁? Explain.
...
you think RuBisCO carries out more carboxylation in C₁ plants?
...
6. Why is the colour of a leaf kept in the dark frequently becomes yellow, or pale
...
8. Figure 11.10 shows the effect of light on the rate of photosynthesis. Based on the
