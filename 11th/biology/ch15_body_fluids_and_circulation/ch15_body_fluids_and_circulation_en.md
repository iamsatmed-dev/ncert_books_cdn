# NCERT: 11TH_BIOLOGY_CH15_BODY_FLUIDS_AND_CIRCULATION_CH15_BODY_FLUIDS_AND_CIRCULATION_EN
...
purpose. Another body fluid, lymph, also helps in the transport of
certain substances. In this chapter, you will learn about the composition
...
like Na+, Ca++, Mg++, HCO₃, Cl-, etc. Glucose, amino acids, lipids, etc., are
...
relatively lesser in number which averages 6000-8000 mm-³ of blood.
...
two major types
'B' and 'T' forms. Both B and T lymphocytes are
...
contains 1,500,00-3,500,00 platelets mm-³. Platelets can release a variety
...
called the nodal tissue is also distributed in the heart (Figure 15.2). А
...
potentials, i.e., 70-75 min¯¹, and is responsible for initiating and
...
letter from P to T that corresponds to a specific Figure 15.3 Diagrammatic presentation of a
...
a possible abnormality or disease. Hence, it is of a great of a grea
...
systemic circulation (Figure 15.4). The systemic circulation provides
nutrients, O, and other essential substances to the tissues and takes
CO₂ and other harmful substances away for elimination. A unique
...
High Blood Pressure (Hypertension): Hypertension is the term for
