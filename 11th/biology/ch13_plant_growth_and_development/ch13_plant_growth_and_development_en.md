# NCERT: 11TH_BIOLOGY_CH13_PLANT_GROWTH_AND_DEVELOPMENT_CH13_PLANT_GROWTH_AND_DEVELOPMENT_EN
...
Both
leaves A and B have increased their area by 5 cm² in a given time to
produce A¹, B¹ leaves.
...
absolute increase in area in the given time to give leaves, A¹ and B¹. However,
...
13.2 DIFFERENTIATION, DEDIFFERENTIATION AND
...
GA) or gases (ethylene, C₂H₄). Plant growth regulators are variously
...
urine. The term 'auxin' is applied to the indole-3-acetic acid (IAA), and
to other natural and synthetic compounds having certain growth
regulating properties. They are generally produced by the growing apices
of the stems and roots, from where they migrate to the regions of their
action. Auxins like IAA and indole butyric acid (IBA) have been isolated
from plants. NAA (naphthalene acetic acid) and 2, 4-D (2, 4-
...
(b)
Figure 13.11 Apical dominance in plants :
...
as GA, GA, GA, and so on. However,
Gibberellic acid (GA) was one of the first
...
be left on the tree longer so as to extend the market period. GA₃ is used to
...
tissue/orga
tissue/organ
/organism. One can define three principle phases of growth
