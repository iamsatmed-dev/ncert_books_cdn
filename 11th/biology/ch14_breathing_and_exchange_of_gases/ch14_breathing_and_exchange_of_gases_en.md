# NCERT: 11TH_BIOLOGY_CH14_BREATHING_AND_EXCHANGE_OF_GASES_CH14_BREATHING_AND_EXCHANGE_OF_GASES_EN
...
As you have read earlier, oxygen (O₂) is utilised by the organisms to
...
(CO₂) which is harmful is also released during the above catabolic
reactions. It is, therefore, evident that O₂ has to be continuously provided
to the cells and CO2 produced by the cells have to be released out. This
process of exchange of O₂ from the atmosphere with CO₂ produced by the
...
with CO₂ by simple diffusion over their entire body surface. Earthworms
...
temperature. Exchange part is the site of actual diffusion of O₂ and CO₂
...
release of CO2 (cellular respiration as dealt in the Chapter 12).
...
pulmonary volume. An increase in
pulmonary volume decreases the intra-
pulmonary pressure to less than the
increased atmospheric pressure which forces the air
from outside to move into the lungs, i.e.,
inspiration (Figure 14.2a). Relaxation of the
...
pressure causing the expulsion of air from
the lungs, i.e., expiration (Figure 14.2b). We
have the ability to increase the strength of
...
A person can inspire by a forcible inspiration.
...
Total Lung Capacity (TLC): Total volume of air accommoda RV, TVatishe

lungs at the end of a forced inspiration. This includes $ RV
...
occur between blood and tissues. O₂ and CO₂ are exchanged in these
...
Figure 14.3 Diagrammatic representation of exchange of gases at the alveolus and
...
a gradient is present for CO₂ in the opposite direction, i.e., from tissues to
blood and blood to alveoli. As the solubility of CO₂ is 20-25 times higher
...
Endothelium of
blood capillary membrane supporting the squamous
...
Blood is the medium of transport for O₂ and CO2. About 97 per cent of O₂ is
transported by RBCs in the blood. The remaining 3 per cent of O₂ is carried
in a dissolved state through the plasma. Nearly 20-25 per cent of CO₂ is
...
RBCs. O, can bind with haemoglobin in a reversible manner to form
...
of haemoglobin with O₂ is plotted against the
...
clearly indicates that O₂ gets bound to
...
O₂ to the tissues under normal physiological
...
CO₂ is carried by haemoglobin as carbamino-haemoglobin (about

2

20-25 per cent). This binding is related to the partial pressure of CO2.
pO, is a major factor which could affect this binding. When pCO₂ is high
and po, is low as in the tissues, more binding of carbon dioxide occurs
whereas, when the pCO₂ is low and pO2 is high as in the alveoli, dissociation
...
of CO2 from carbamino-haemoglobin takes place, i.e., CO₂ which is bound
...
At the tissue site where partial pressure of CO₂ is high due to
catabolism, CO₂ diffuses into blood (RBCs and plasma) and forms HCO
and H⁺'. At the alveolar site where pCO₂ is low, the reaction proceeds in
the opposite direction leading to the formation of CO2 and H2O. Thus,
CO₂ trapped as bicarbonate at the tissue level and transported to the
alveoli is released out as CO₂ (Figure 14.4). Every 100 ml of deoxygenated
ml of de
blood delivers approximately 4 ml of CO₂ to the alveoli.
...
changes in CO₂ and H⁺ concentration and send necessary signals to the
...
The first step in respiration is breathing by which atmospheric mospheric air is taken in
(inspiration) and the alveolar air is released out (expiration). Exchange of O₂ and
CO₂ between deoxygenated blood and alveoli, transport of these gases throughout
the body by blood, exchange of O₂ and CO₂ between the oxygenated blood and
tissues and utilisation of O₂ by the cells (cellular respiration) are the other steps
involved.
...
Exchange of O₂ and CO₂ at the alveoli and tissues occur by diffusion. Rate of
diffusion is dependent on the partial pressure gradients of O₂ (pO₂) and CO2 (pCO2),
their solubility as well as the thickness of the diffusion surface. These factors in
our body facilitate diffusion of O₂ from the alveoli to the deoxygenated blood as
well as from the oxygenated blood to the tissues. The factors are favourable for the
diffusion of CO₂ in the opposite direction, i.e., from tissues to alveoli.

2

2

Oxygen is transported mainly as oxyhaemoglobin. In the alveoli where pO2 is
higher, O₂ gets bound to haemoglobin which is easily dissociated at the tissues
where po, is low and pCO2 and H⁺ concentration are high. Nearly 70 per cent of
carbon dioxide is transported as bicarbonate (HCO3) with the help of the enzyme
carbonic anhydrase. 20-25 per cent of carbon dioxide is carried by haemoglobin
as carbamino-haemoglobin. In the tissues where pCO, is high, it gets bound to
blood whereas in the alveoli where pCO, is low and pO, is high, it gets removed
from the blood.
...
### 5. What will be the pO2 and pCO₂ in the atmospheric air compared to those in the
alveolar air?

(i)

pO2 lesser, pCO₂ higher

(ii)

PO, higher, pCO2 lesser

(iii)

2

PO, higher, pCO, higher

(iv)

2

pO2 lesser, pCO₂ lesser
