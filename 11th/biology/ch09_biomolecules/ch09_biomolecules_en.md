# NCERT: 11TH_BIOLOGY_CH09_BIOMOLECULES_CH09_BIOMOLECULES_EN
...
9.1 How ΤΟ ANALYSE CHEMICAL COMPOSITION?
...
acid (CICCOOH) using a mortar and a pestle. We obtain a thick slurry. If
...
dry TABLE 9.2 A List of Representative Inorganic
...
could be a methyl (–CH3), or ethyl (−C₂H₄) or higher number of –CH2
...
categories of compounds shown in Figure 9.1. These are primary
metabolites. However, when one analyses plant, fungal and microbial cells,
one would see thousands of compounds other than these primary
...
As you notice in Figure 9.1, the heterocyclic compounds in n in nucleic
...
refers to the molecular formulae (e.g., NaCl, MgCl₂, etc.). Organic
...
secondary structure (Fig. 9.3 b). In
...
Some proteins are an assembly of more than one polypeptide
or subunits. The manner in which these individual folded
polypeptides or subunits are arranged with respect to each other
(e.g. linear string of spheres, spheres arranged one upon each
other in the form of a cube or plate etc.) is the architecture of a
protein otherwise called the quaternary structure of a protein
(Fig. 9.3 d). Adult human haemoglobin consists of 4 subunits.
Two of these are identical to each other. Hence, two subunits of a
type and two subunits of ẞ type together constitute the human
haemoglobin (Hb).
...
formed every second. The enzyme has accelerated the reaction rate by
about 10 million times. The power of enzymes is incredible indeed!

There are thousands of types of enzymes each catalysing a unique
chemical or metabolic reaction. A multistep chemical reaction, when
each of the steps is catalysed by the same enzyme complex or different
...
C6H12O6 + O2 → 2C₂H₄ O3 + 2H2O

is actually a metabolic pathway in which glucose becomes pyru pyruvic acid
...
Sand P. If 'P' is at a lower level than 'S', the reaction
...
S reduced + S' oxidised → Soxidised + S' reduced.
...
Find and write down structures of 10 interesting sposo
