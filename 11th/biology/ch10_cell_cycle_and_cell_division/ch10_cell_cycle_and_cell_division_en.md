# NCERT: 11TH_BIOLOGY_CH10_CELL_CYCLE_AND_CELL_DIVISION_CH10_CELL_CYCLE_AND_CELL_DIVISION_EN
...
these
these 
processes, i.e., cell division, DNA replication, and cell growth, hence,
...
successive M phases. It is significant to note that Figure 10.1 A view of cell cycle
...
G₁ phase corresponds to the interval between mitosis and initiation
of DNA replication. During G₁ phase, the cell is metabolically active and
...
of chromosomes at G₁, even after S phase the number of chromosomes
...
(e.g., heart cells) and many other cells divide only occasionally, as needed
to replace cells that have been lost because of injury or cell death.
These cells that do not divide further exit G₁ phase to enter an inactive
stage called quiescent stage (G) of the cell cycle. Cells in this stage
...
This is the most dramatic period of the cell cycle, involv involving a major
...
S and G₂ phases of interphase. In the S and G₂ phases, the new DNA
...
attachment of spindle fibres to the chromosomes that are
moved into position at the centre of the cell. Hence, the
metaphase is characterised by all the chromosomes coming
to lie at the equator with one chromatid of each chromosome
connected by its kinetochore to spindle fibres from one
pole and its sister chromatid connected by its kinetochore
to spindle fibres from the opposite pole (Figure 10.2 b).
The plane of alignment of the chromosomes at metaphase
is referred to as the metaphase plate. The key features
of metaphase are:
...
The production of offspring by sexual reproduction includes the fuelushed
...
I called zygotene. During this stage, chromosomes start pairing
together and this process of association is called synapsis. Such paired
...
chromosomes becomes distinct and clearly appear as tetrads. This
stage is characterised by the appearance of recombination nodules,
the sites at which crossing over occurs between non-sister chromatids
of the homologous chromosomes. Crossing over is the exchange of
genetic material between two homologous chromosomes. Crossing over
is also an enzyme-mediated process and the enzyme involved is called
...
cytokinesis follows and this is called as dyad of cells (Figure 10.3).
...
the cell cycle. Cell cycle is divided into two phases called (i) Interphase
period of preparation for cell division, and (ii) Mitosis (M phase) – the actual
period of cell division. Interphase is further subdivided into G₁, S and G2. G₁
...
the phase of DNA replication and chromosome duplication. G₂ phase is the
