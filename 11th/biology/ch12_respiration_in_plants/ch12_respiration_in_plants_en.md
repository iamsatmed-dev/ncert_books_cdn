# NCERT: 11TH_BIOLOGY_CH12_RESPIRATION_IN_PLANTS_CH12_RESPIRATION_IN_PLANTS_EN
...
some macromolecules that we call ‘food. Green plants and cyanobacteria
can prepare their own food; by the process of photosynthesis they trap
light energy and convert it into chemical energy that is stored in the bonds
of carbohydrates like glucose, sucrose and starch. We must remember
that in green plants too, not all cells, tissues and organs photosynthesise;
only cells containing chloroplasts, that are most often located in the
superficial layers, carry out photosynthesis. Hence, even in green plants
all other organs, tissues and cells that are non-green, need food for
...
systems in place that ensure the availability of O₂. Plants, unlike animals,
...
during these periods. When cells photosynthesise, availability of O₂ is not
a problem in these cells since O₂ is released within the cell. Third, the
...
O₂ is not available? There are sufficient reasons to believe that the first
...
The term glycolysis colysis has originated from the Greek words, glycos for sugar,
...
For the complete oxidation of glucose to CO₂ and H₂O, however, organisms
...
fermented to alcohol or lactic acid? Yeasts
poison themselves to death when the
concentration of alcohol reaches about 13 per
cent. What then would be the maximum
concentration of alcohol in beverages that
are naturally fermented? How do you think
...
and this requires O2. Aerobic respiration is the process that leads to a
complete oxidation of organic substances in the presence of oxygen, and
releases CO₂, water and a large amount of energy present in the substrate.
...
atoms to molecular O₂ with simultaneous synthesis of ATP.
...
where FAD+ is reduced to FADH2. The
...
CO2 and eight molecules of NADH + H+ and two of FADH, have been
...
is synthesised? Let us now understand the role of O₂ in respiration and
...
the energy stored in NADH+H+ and FADH, This is accomplished when
...
reducing equivalents via FADH, (complex
...
cytochrome e via cytochrome bc₁
complex (complex III). Cytochrome cis a
...
system. Oxygen acts as the final hydrogen acceptor. Unlike
...
the F₁ component for the production of ATP.
For each ATP produced, 4H+ pass through Fo
...
Figure 12.5 Diagr Diagramatic presentation of ATP
...
It is possible to make calculations of the net gain of ATP for every
glucose molecule oxidised; but in reality this can remain only a
theoretical exercise. These calculations can be made only on certain
assumptions that:

• There is a sequential, orderly pathway functioning, with one
substrate forming the next and with glycolysis, TCA cycle and
ETS pathway following one after another.
...
Only glucose is being respired – no other alternative substrates
...
all pathways work simultaneously and do not take place one after
another; substrates enter the pathways and are withdrawn from it as
and when necessary; ATP is utilised as and when needed; enzymatic
rates are controlled by multiple means. Yet, it is useful to do this
exercise to appreciate the beauty and efficiency of the living system in
...
whereas in aerobic respiration it is completely degraded to CO₂ and
H₂O.
...
mediated breakdown of different organic molecules to CO₂ and H₂O
...
aerobic respiration, O₂ is consumed and CO₂ is released. The ratio of the
volume of CO, evolved to the volume of O₂ consumed in respiration is
...
2(C51H98O6)+1450₂ →102CO₂ +98H2O+ energy
...
substrates are often more than one; pure proteins or fats are never
...
The breaking of EC bonds of complex organic molecules by oxidation leading
to the release of a lot of energy is called cellular respiration. Glucose is the
...
mitochondria where it is converted into acetyl CoA with the release of CO2. Acetyl
...
oxidative phosphorylation. In this process O₂ is the ultimate acceptor of electrons
