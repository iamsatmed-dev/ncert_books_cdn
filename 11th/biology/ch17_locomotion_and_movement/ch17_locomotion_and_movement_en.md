# NCERT: 11TH_BIOLOGY_CH17_LOCOMOTION_AND_MOVEMENT_CH17_LOCOMOTION_AND_MOVEMENT_EN
...
Movement is one of the significant features of of ] living be beings. Animals and
...
and swimming are all some forms of locomotory movements. Locomotory
...
substances inhaled along with the atmospheric air. Passage of ova through
...
movement. The contractile property of muscles are effectively used for
locomotion and other movements by human beings and majority of
multicellular organisms. Locomotion requires a perfect coordinated
activity of muscular, skeletal and neural systems. In this chapter, you
will learn about the types of muscles, their structure, mechanism of
their contraction and important aspects of the skeletal sys system.
...
and in locomotion of Protists like Euglena. Muscle is a specialised
...
system (CNS) via a motor neuron. A motor neuron along with the muscle
...
neuromuscular junction or motor-end plate. A neural signal reaching this
junction releases a neurotransmitter (Acetyl choline) which generates an
action potential in the sarcolemma. This spreads through the muscle fibre
and causes the release of calcium ions into the sarcoplasm. Increase in
...
Figure 17.4 Stages in cross bridge formation, rotation of head and breaking of

This pulls the attached actin filaments towards the centre of ‘A band. The
...
sets of bones – cranial and facial, that totals to 22 bones. Cranial bones
are 8 in number. They form the hard protective outer covering, cranium
for the brain. The facial region is made up of 14 skeletal elements which
form the front part of the skull. A single U-shaped bone called hyoid is
present at the base of the buccal cavity. Each middle ear contains three
...
(false) ribs. Last 2 pairs (11th and 12th) of
...
girdles constitute the appendicular Floating ribs-12
...
of
of 
the thorax between the second and the
