# NCERT: 11TH_BIOLOGY_CH16_EXCRETORY_PRODUCTS_AND_THEIR_ELIMINATION_CH16_EXCRETORY_PRODUCTS_AND_THEIR_ELIMINATION_EN
...
Figure 16.2 Longitudinal se section (Diagrammatic)
...
Figure 16.3 A diagrammatic representation of a nephron showing blood vessels,
...
(PCT). A hairpin shaped Henle's loop is
...
convoluted tubule (DCT). The DCTs of
many nephrons open into a straight tube
called collecting duct, many of which
converge and open into the renal pelvis
through medullary pyramids in the
calyces.
...
Figure 16.4 Malpighian body (renal corpuscle) the medulla. Such nephrons are called
...
of HCO and selective secretion of hydrogen and potassium ions and
...
Figure 16.5 Reabsorption and secretion of major substances at different parts of
...
from 300 mOsmolL¯¹ in the cortex to about 1200 mOsmolL¯¹ in the inner
...
Our lungs remove large amounts of CO₂ (approximately 200mL/
...
Many nitrogen containing substances, ions, CO₂, water, etc., that accumulate in
...
(300 mOsmolL-1 -1200 mOsmolL¯¹) within the kidney interstitium. DCT and
collecting duct allow extensive reabsorption of water and certain electrolytes, which
help in osmoregulation: H+, K+ and NH3 could be secreted into the filtrate by the
...
mOsmolL-¹ to 1200 mOsmolL¯¹, an excellent mechanism of conservation of water.
