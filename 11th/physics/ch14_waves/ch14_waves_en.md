# NCERT: 11TH_PHYSICS_CH14_WAVES_CH14_WAVES_EN
...
Fig. 14.1 A collection of springs connected to each
...
say say dp, this change induces a change in pressure,
8p, in that region. Pressure is force per unit area,
...
Fig. 14.3 A harmonic (sinusoidal) wave travelling
...
Example 14.1 Given below are some
...
DISPLACEMENT ENT RELATION IN

A PROGRESSIVE WAVE

For mathematical description of a travelling
wave, we need a function of both position xand
...
To understand why Equation (14.2)
...
Equation (14.2) is constant -ot. The
...
simple harmonic motion. Finally, as tincreases,
x must increase in the positive direction to keep
kx-wt + constant. Thus, Eq. (14.2) represents
...
the various quantities of Eq. (14.2).

14.3.1 Amplitude and Phase

(14.2) for 14.3.1

Fig. 14.6 shows the plots of Eq. (14.2) for
...
by a solid dot (•). The plots of Fig. 14.6 show
...
In Eq. (14.2), since the sine function varies
...
The quantity (kx – wt + $) appearing as the
argument of the sine function in Eq. (14.2) is
called the phase of the wave. Given the
amplitude a, the phase determines the
displacement of the wave at any position and
at any instant. Clearly $ is the phase at x = 0
and t = 0. Hence, o is called the initial phase
angle. By suitable choice of origin on the x-axis
and the intial time, it is possible to have ¢ = 0.
...
troughs in a wave. Taking ¢ = 0 in Eq. (14.2),
...
every 2 change in angle,

sin kx = sin(kx + 2ηπ) = sink x +
...
14.3.3 Period, Angular Frequency and
Frequency

Fig. 14.7 shows again a sinusoidal plot. It
...
of time. We may for, simplicity, take Eq. (14.2)
with $ = 0 and monitor the motion of the element
say at x = 0. We then get
...
Its SI unit is rad s¯¹. The frequency v is the
...
wave. In Eq. (14.2), the displacement function
...
of the wave at position xand time t. In Eq. (14.9),
a is the displacement amplitude; other
...
Here again, 'radian' could be dropped and the units could be written merely as m¯¹. Thus, k represents 2π
...
Example 14.2 A wave travelling along a
...
x = 30.0 cm and time t = 20s?

Answer On comparing this displacement
equation with Eq. (14.2),
...
We, then, relate the wavelength A to k through
Eq. (14.6),
...
then Ax/At. We can put the dot (•) on a point
...
motion of the crest of the wave. Fig. 14.8 gives

kx-wt = k(x+x) –w(t+A)

or k Ax- @At=0

Taking Ax, At vanishingly small, this gives
...
Relating o to Tand k to λ, we get
...
Eq. (14.12), a general relation for all progressive
waves, shows that in the time required for one full
oscillation by any constituent of the medium, the
wave pattern travels a distance equal to the
wavelength of the wave. It should be noted that
the speed of a mechanical wave is determined by
the inertial (linear mass density for strings, mass
density in general) and elastic properties (Young's
...
the speed; Eq. (14.12) then relates wavelength to
frequency for the given speed. Of course, as
remarked earlier, the medium can support both
transverse and longitudinal waves, which will have
different speeds in the same medium. Later in this
chapter, we shall obtain specific expressions for
the speed of mechanical waves in some media.
...
Example 14.3 A steel wire 0.72 m long
has a mass of 5.0 ×10-3 kg. If the wire is
under a tension of 60 N, what is the speed
...
and μ (Tis a property of the stretched string
...
Thus, if B and pare considered to be the only
relevant physical quantities,
...
where, as before, Cis the undetermined constant
...
Now, see Eq. (14.19). Solids and liquids have
...
the pressure P, volume Vand temperature Tare
rature
related by (see Chapter 10).
...
where Nis the number of molecules in volume
...
Example 14.4 Estimate the speed of
...
p = (mass of one mole of air)/ (volume of one
mole of air at STP)
...
of 331 m s¹ as given in Table 14.1. Where
...
y=7/5. Now using Eq. (14.24) to estimate the speed
...
an algebraic sum of the two. Fig. 14.9 gives
...
mathematically, let y₁ (x,t) and y₂ (x,t) be the
...
the same @ (angular frequency) and k (wave
...
initial phase. According to Eq. (14.2), the two
...
depends on the phase difference $, which
...
For ¢ = 0, when the waves are in phase,

and y₂(x, t) = a sin (kx − wt + ¢)
...
y(x,t) = 2a cos sinkx-ot+2)

2

(14.31)

Eq. (14.31) is also a harmonic travelling wave in
...
Eq. (14.33) refers to the so-called constructive
interference of the two waves where the
amplitudes add up in the resultant wave. Eq.
(14.34) is the case of destructive intereference
where the amplitudes subtract out in the
resultant wave. Fig. 14.10 shows these two cases
of interference of waves arising from the
principle of superposition.

14.6 REFLECTION OF WAVES

So far we considered waves propagating in an
unbounded medium. What happens if a pulse
...
phenomenon of echo is an example of reflection
by a rigid boundary. If the boundary is not
completely rigid or is an interface between two
different elastic media, the situation is some
...
suffers a phase change of π or 180º on reflection.
...
suffers a phase change of πon reflection at a
rigid boundary and no phase change on
reflection at an open boundary. To put this
mathematically, let the incident travelling
wave be
...
Clearly, at the rigid boundary, y = y2 + y, = (
...
From Eqs. (14.2) and (14.4), with ¢ = 0, we get:
...
= a [sin (kx-wt) + sin (kx + t)]

Using the familiar trignometric identity
Sin (A+B) + Sin (A–B) = 2 sin A cosB we get,

y(x, t) = 2a sin kx cos ot

(14.37)

Note the important difference in the wave
pattern described by Eq. (14.37) from that
described by Eq. (14.2) or Eq. (14.4). The terms
kx and ot appear separately, not in the
combination kx - wt. The amplitude of this wave
...
angular frequency @ or time period. There is no
...
First, from Eq. (14.37), the positions of nodes
...
x = =(n+2) (n + 2) 2 ; n = 0, 1, 2, 3, ...

(14.39)

Again the distance between any two consecutive

speed of wave determined by the properties of
the medium. The n = 2 frequency is called the
...
superposition of different modes; some modes
may be more strongly excited and some less.
Musical instruments like sitar or violin are
based on this principle. Where the string is
plucked or bowed, determines which modes are
more prominent than others.

Let us next consider normal modes of
oscillation of an air column with one end closed

λ

antinodes is

### 2. Eq. (14.38) can be applied to
...
frequencies - the normal modes of K
...
to n = 1 of Eq. (14.42). Here v is the
...
and the other open. A glass tube partially filled
with water illustrates this system. The end in
contact with water is a node, while the open end
is an antinode. At the node the pressure
changes are the largest, while the displacement
is minimum (zero). At the open end the
antinode, it is just the other way - least pressure
change and maximum amplitude of
displacement. Taking the end in contact with
water to be x = 0, the node condition (Eq. 14.38)
is already satisfied. If the other end x = L is an
antinode, Eq. (14.39) gives
...
Example 14.5 A pipe, 30.0 cm long, is open
at both ends. Which harmonic mode of the
pipe resonates a 1.1 kHz source? Will
...
resonate at v₂, i.e. the second harmonic.
...
Fig. 14.14 Normal modes of an air column open at
one end and closed at the other end. Only
the odd harmonics are seen to be possible.

Now if one end of the pipe is closed (Fig. 14.15),
it follows from Eq. (14.15) that the fundamental
frequency is

υ υ

V1= =4L =41 (pipe closed at one end)
...
angular frequency w₁ and ໙, and fix the location
to be x = 0 for convenience. Eq. (14.2) with a
suitable choice of phase ($ = π/2 for each) and,
assuming equal amplitudes, gives

s₁ = a cos @t_and_s₂ = a cos @₂t (14.45)

Here we have replaced the symbol y by s,
since we are referring to longitudinal not
transverse displacement. Let w₁ be the (slightly)
...
Now if we assume「@₁-02] <<@₁, which means
>> ω, we can interpret Eq. (14.47) as follows.
The resultant wave is oscillating with the average
angular frequency ω; however its amplitude is
not constant in time, unlike a pure harmonic
wave. The amplitude is the largest when the
term cos ot takes its limit +1 or −1. In other
...
Example 14.6 Two sitar strings A and B
...
of B (v) were greater than that of A (v), further
increase in v should have resulted in an
increase in the beat frequency. But the beat
frequency is found to decrease. This shows that
VB < VA. Since V₁ – VƉ = 5 Hz, and v₁ = 427 Hz, we
get vB = 422 Hz.
...
where a is the amplitude of the wave, kis the angular wave number, w is the angular
frequency, (kx− wt + ¢) is the phase, and ¢ is the phase constant or phase angle.
...
on a stretched string is set by the properties of the

11. Sound waves are longitudinal mechanical waves that can travel through solids, liquids,
or gases. The speed v of sound wave in a fluid having bulk modulus B and density pis
...
constant d, the result is a single wave with the same frequency @ :
...
If 4 = 0 or an integral multiple of 2n, the waves are exactly in phase and the interference
is constructive; if = π, they are exactly out of phase and the interference is destructive.
...
string with fixed ends, the standi opposite

y (x, t) = [2a sin kx] cos ot

given by

Standing waves are characterised by fixed locations of zer zero displacement called nodes
...
17. Beats arise when two waves having slightly different frequencies, v₁ and v₂ and
...
In a mechanical wave, energy transfer takes place because of the coupling through
...
Relative to an observer at rest in a medium the speed of a mechanical wave in that
...
A stone dropped from the top of a tower of height 300 m splashes into the water of
a pond near the base of the tower. When is the splash heard at the top given that
the speed of sound in air is 340 m s¯¹? (g = 9.8 m s¯²)
...
y = f (x, t) where x and t must appear in the combination x − vtor x + vt, i.e.
...
sound? Speed of sound in air is 340 m s-¹ and in water 1486 m s-¹.
...
the oscillatory motion in travelling wave
frequency or phase ?
...
is 4.0 × 10-2 kg m-¹. What is (a) the speed of a transverse wave on the string, and
...
a violin note and sitar note may have the same frequency, yet we can
distinguish between the two notes,

solids can support both longitudinal and transverse waves, but only
