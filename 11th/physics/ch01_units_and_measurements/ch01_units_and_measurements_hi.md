...
graph TD
    ...
    B1 --> B1a["SI मूल मात्रक (7)<br/>m, kg, s, A, K, mol, cd"]:::leaf
    B1 --> B1b["पूरक मात्रक (2)<br/>समतलीय कोण (rad), घन कोण (sr)"]:::leaf
    B1 --> B1c["व्यावहारिक मात्रक<br/>1 AU, 1 ly, 1 pc, 1 Å"]:::leaf

    B2 --> B2a["वर्नियर कैलिपर्स<br/>LC = 1 MSD - 1 VSD"]:::leaf
    B2 --> B2b["स्क्रू गेज (पेंचमापी)<br/>LC = Pitch / कुल वृत्तीय भाग"]:::leaf
    B2 --> B2c["⚠️ शून्यांक त्रुटि नियम<br/>वास्तविक पाठ्यांक = मापित - (±शून्यांक त्रुटि)"]:::trap

    B3 --> B3a["त्रुटियों के प्रकार<br/>क्रमबद्ध (यंत्र, प्रयोग, व्यक्तिगत) vs यादृच्छिक"]:::leaf
    B3 --> B3b["⚠️ घात त्रुटि नियम (Power Rule)<br/>Z = (A^p B^q)/C^r : ΔZ/Z = p(ΔA/A) + q(ΔB/B) + r(ΔC/C)"]:::trap
    B3 --> B3c["सार्थक अंक (5 नियम)<br/>अशून्य, मध्य शून्य, अनुगामी दशमलव"]:::leaf
    B3 --> B3d["निकटन नियम (Rounding Off)<br/>5 से अधिक, 5 से कम, एवं सम-विषम नियम"]:::leaf

    B4 --> B4a["विमाओं की समांगता<br/>LHS विमा = RHS विमा"]:::leaf
    B4 --> B4b["3 अनुप्रयोग<br/>यथार्थता जांच, मात्रक रूपांतरण, सूत्र निर्माण"]:::leaf
    B4 --> B4c["⚠️ विमीय सीमाएं<br/>विमाहीन नियतांक k, sinθ, e^x, ln(x) का निर्धारण संभव नहीं"]:::trap
```
