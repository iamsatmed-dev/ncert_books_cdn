# NCERT: 11TH_PHYSICS_CH09_MECHANICAL_PROPERTIES_OF_FLUIDS_CH09_MECHANICAL_PROPERTIES_OF_FLUIDS_EN
...
(a)
(a) The force exerted by the liquid in the
...
[ML-¹T-2]. The SI unit of pressure is N m¯². It has
...
describing fluids, is the density p. For a fluid of
...
unit is kg m³. It is a positive scalar quantity. A
...
1.0 × 103 kg m³. The relative density of a
...
2.7 x 103 kg m¯³ The densities of some common
fluids are displayed in Table 9.1.

Table 9.1

STP means standard temperature (0°C) and 1 atm pressure.
...
Example 9.1 The two thigh bones (femurs),
each of cross-sectional area 10 cm² support
...
femurs is A = 2 × 10 cm² = 20 × 10-4 m². The
force acting on them is F = 40 kg wt = 400 N
(taking g = 10 m_s¯²). This force is acting
...
forces F, F and F as shown in Fig. 9.2 on the
faces BEFC, ADFC and ADEB denoted by A₂, A
...
Proof of Pascal's law. ABC-DEF is an
...
Thus, the fluid exerts pressures P, Pand Pon
...
the fluid pressure at the top (PA) acting
downward, at the bottom (P,A) acting upward.
...
(9.5)
Now, if p is the mass density of the fluid, we
have the mass of fluid to be m = pV= phA so
that
...
density of the fluid p and acceleration due to
gravity g. If the point 1 under discussion is
shifted to the top of the fluid (say, water), which
is open to the atmosphere, P₁ may be replaced
by atmospheric pressure (P) and we replace P₂
...
amount pgh. The excess of pressure, P – P, at
...
Illustration of hydrostatic paradox. The
...
h = 10 m and p = 1000 kg m³. Take g = 10 m s
From Eq. (9.7)
...
Pis so small that it may be neglected. Thus,
...
value of p in Eq. (9.8). A common way of stating
...
to measure [see Fig. 9.5 (b)]. The pressure Pat A
is equal to pressure at point B. What we
normally measure is the gauge pressure, which
is P− P, given by Eq. (9.8) and is proportional to
manometer height h.
...
pgh = 1.29 kg m³ × 9.8 m s² × h m = 1.01 × 105 Pa
...
Answer Here h = 1000 m and p = 1.03 × 103 kg m³.
...
+ 1.03 × 103 kg m¯³ × 10 m s¯² × 1000 m
104.01 × 105 Pa

≈ 104 atm

(b) Gauge pressure is P− P = pgh = P
...
P = 1.03 × 103 kg m¯³× 10 ms² × 1000 m
= 103 × 105 Pa
≈ 103 atm

(c) The pressure outside the submarine is
P= P + pgh and the pressure inside it is P.
Hence, the net pressure acting on the
window is gauge pressure, P = pgh. Since
the area of the window is A = 0.04 m², the
force acting on it is

g

F=PA=103 × 105 Pa× 0.04 m² = 4.12 × 105 N
...
cross-section A₁ is used to exert a force F₁ directly
...
placed on the platform) F₂ = PA₂ =
changing the force at A₁, the platform can be
...
at three points P, Rand Q in Fig.9.7 (b). The plane
...
the surfaces as indicated at P, R and is the
same. If area of cross-sections at these points
are Ap,AR and A and speeds of fluid particles
are vp, VR and v₁, then mass of fluid Amp crossing
at A in a small interval of time At is ppAv, At.
Similarly mass of fluid ∆m flowing or crossing
at Ar in a small interval of time At is PRARVR At
and mass of fluid Am is PAvAt crossing at
A. The mass of liquid flowing out equals the
...
is clear that AR > A or VR < vo, the fluid is
...
but their directions are parallel. Figure 9.8 (b)
...
(a) Some streamlines for fluid flow.
...
interval At, this fluid would have moved. Suppose
v₁ is the speed at B and v₂ at D, then fluid initially
at B has moved a distance v₁ At to C (v₁At is small
enough to assume constant cross-section along
BC). In the same interval At the fluid initially at
D moves to E, a distance equal to v₂∆t. Pressures
P₁ and P₂ act as shown on the plane faces of
areas A₁ and A₂ binding the two regions. The
work done on the fluid at left end (BC) is W₁ =
PA(vt) = PAV. Since the same volume AV
passes through both the regions (from the
equation of continuity) the work done by the fluid
at the other end (DE) is W₂ = P2A₂(v2∆t) = P2∆Vor,
...
the work done on the fluid is −P2AV. So the total
...
of the fluid is pand Am = pA₁v₁∆t = p∆V is the
...
(P-P2) AV=PV(v22- v,2) + pgAV (h₂– h₁)

We now divide each term by AV to obtain
...
The flow of an ideal fluid in a pipe of varying
cross section. The fluid in a section of length
v At moves to the section of length v At in
time At.
...
per unit volume (pgh) remains a constant.
...
Fig. 9.10 Torricelli's law. The speed of efflux, v₁,
...
atmosphere then v₁ = √2 gh.

If the cross-sectional area of the tank A, is
much larger than that of the hole (A₂ >>A₁), then
we may take the fluid to be approximately at rest
at the top, i.e., v₂ = 0. Now, applying the Bernoulli
equation at points 1 and 2 and noting that at
the hole P₁ = P, the atmospheric pressure, we
have from Eq. (9.12)
...
open to the atmosphere, then P = Pand
...
when it moves horizontally through air. The
...
(a) Fluid streaming past a static sphere. (b) Streamlines for a fluid around a sphere spinning clockwise.
(c) Air flowing past an aerofoil.

Example 9.7 A fully loaded Boeing aircraft
has a mass of 3.3 × 105 kg. Its total wing
area is 500 m². It is in level flight with a
...
(b) We ignore the small heig height difference
...
where v is the speed of air over the upper
surface and v₁ is the speed under the bottom
...
change of strain' or 'strain rate' i.e. ∆x/(1∆t) or
v/1 instead of strain itself. The coefficient of
...
other units are N s m² or Pa s. The dimensions
of viscosity are [ML-¹T¹]. Generally, thin liquids,
...
moving to the right with velocityv
...
time (At). During this time interval the liquid has
undergone a shear strain of Ax/1. Since, the
...
Example 9.8 A metal block of area 0.10 m² is
...
suspended mass m. Thus, the shear force Fis
...
where p and o are mass densities of sphere and
...
So the terminal velocity v depends on the
...
a tank of oil at 20°C is 6.5 cm s¯¹. Compute
the viscosity of the oil at 20°C. Density of
oil is 1.5 ×103 kg m³, density of copper is
8.9 x 103 kg m-³.

Answer We have v = 6.5 × 10-2 ms˜¯¹, a = 2 × 10-3 m,
g = 9.8 ms¯², p = 8.9 × 103 kg m³,

σ =1.5 ×103 kg m³. From Eq. (9.18)
...
other things like volume fixed requires a
...
Surface tension of some liquids at the
...
by 0. It is different at interfaces of different pairs
of liquids and solids. The value of 0 determines
...
S₁₁ = (W/21) = (mg/2l)
(9.21)
where m is the extra mass and I is the length of
the
...
Different shapes of water drops with
...
solid-liquid denoted by Sia, Sa and S₁₁, respectively
...
S > Sa as in the case of water-leaf interface
while it is an acute angle if S₁₁ < S₁₂ as in the
case of water-plastic interface. When 0 is an
...
the solid, this will reduce S and therefore,
cos e may increase or 6 may decrease. In this
...
(9.28)
where p is the density of water and his called
...
to surface tension. It is larger, for a smaller a.
...
as for mercury, i.e., if cos e is negative then from
...
7.30 × 10-2 Nm¯¹. 1 atmospheric pressure =
1.01 × 105 Pa, density of water = 1000 kg/m³,
g = 9.80 m s². Also calculate the excess
pressure.
...
outside the bubble Pequals atmospheric
pressure plus the pressure due to 8.00 cm of
water column. That is

-3

P = (1.01 (1.01 × 105 Pa + 0.08 m × 1000 kg m-³
× 9.80 m s-2)
...
The unit of the pressure is the pascal (Pa). It is the same as N m². Other common
...
where p is the density of the fluid, assumed uniform.
...
Bernoulli's principle states that as we move along a streamline, the sum of the
pressure (P), the kinetic energy per unit volume (p²/2) and the potential energy per
unit volume (pgy) remains a constant.

P + pv2/2 + pgy = constant
...
Pressure is a scalar quantity. The definition of the pressure as "force per unit area"
...
One should not think of pressure of a fluid as being exerted only on a solid like the
...
A streamline is a map of fluid flow. In a steady flow two streamlines do not intersect as
it means that the fluid particle will have two possible velocities at the point.
Bernoulli's principle does not hold in presence of viscous drag on the fluid. The work
...
As the temperature rises the atoms of the liquid become more mobile and the coefficient
of viscosity, η falls. In a gas the temperature rise increases the random motion of
atoms and η increases.

Surface tension arises due to excess potential energy of the molecules on the surface
...
pascal (Pa) 1 atm = 1,013 × 105 Pa, Scalar
...
A 50 kg girl wearing high heel shoes balances on a single heel. The heel is circular with
...
984 kg m³. Determine the height of the wine column for normal atmospheric

pressure.

9.7

A vertical off-shore structure is built to withstand a maximum stress of 10º Pa. Is
...
kg. The area of cross-section of the piston carrying the load is 425 cm². What
...
Can Bernoulli's equation be used to describe the flow of water through a rapid in a
river? Explain.
...
Glycerine flows steadily through a horizontal tube of length 1.5 m and radius 1.0
cm. If the amount of glycerine collected per second at one end is 4.0 × 10-3 kg s¯¹,
what is the pressure difference between the two ends of the tube? (Density of glycerine
= 1.3 × 103 kg m¯³ and viscosity of glycerine = 0.83 Pa s). [You may also like to check
...
In a test experiment on a model aeroplane in a wind tunnel, the flow speeds on the
upper and lower surfaces of the wing are 70 m s¯¹and 63 m s¯¹ respectively. What is
the lift on the wing if its area is 2.5 m² ? Take the density of air to be 1.3 kg m¯³.
...
formed between the wire and the light slider supports a weight of 1.5 × 10¯² N (which
includes the small weight of the slider). The length of the slider is 30 cm. What is
the surface tension of the film?

The cylindrical tube of a spray pump has a cross-section of 8.0 cm² one end of
which has 40 fine holes each of diameter 1.0 mm. If the liquid flow inside the tube
is 1.5 m min¯¹, what is the speed of ejection of the liquid through the holes ?
...
Surface tension of mercury at that temperature (20 °C) is 4.65 × 10¯¹ Ñ¯m¯¹. The
...
10-2 N m¯¹? If an air bubble of the same dimension were formed at depth of 40.0 cm
