# NCERT: 11TH_PHYSICS_CH10_THERMAL_PROPERTIES_OF_MATTER_CH10_THERMAL_PROPERTIES_OF_MATTER_EN
...
scale and 0 Cand 100 °C on the Celsius scale.
...
Fahrenheit temperature (t) versus celsius
temperature (t) in a
straight line (Fig. 10.1),
whose equation is
...
quantity of gas are related as_PV = constant.
...
where, u is the number of moles in the sample of
gas and Ris called universal gas constant:
R = 8.31 J mol-1 K-1
...
Fig. 10.3. This temperature is found to be
...
Fig. 10.4 Comparision of the Kelvin, Celsius and
...
change AT and define the coefficient of volume
expansion (or volume expansivity), α as
...
then for small change in temperature, AT, the
fractional change in length, Al/l, is directly
directly
proportional to AT.
...
Here a₁ is also a characteristic of the
substance but is not strictly a constant. It
depends in general on temperature (Fig 10.6). It
ral
is seen that a becomes constant only at a high
temperature.
...
where a is known as the coefficient of linear
expansion (or linear expansivity) and is
characteristic of the material of the rod. In Table
10.1, typical average values of the coefficient of
linear expansion for some material in the
temperature range 0 °C to 100 Care given. From
this Table, compare the value of a for glass and
...
alloy) having particularly low values of a. From
this Table we find that the value of a for
alcohol (ethanol) is more than mercury and
expands more than mercury for the same rise
in temperature.

Table 10.2 Values of coefficient of volume
...
At 0 °C,
3.7 × 10-3 K-1, which is much
larger than that for solids and liquids.
Equation tion (10.6) shows the temperature
dependence of α; it decreases with increasing
temperature. For a gas at room temperature and
constant pressure, a is about 3300 × 10-6K-1, as
...
coefficient of volume expansion (a) and
coefficient of linear expansion (a). Imagine a
cube of length, 1, that expands equally in all
...
In Equation (10.7), terms in (AI)2 and (AI)3 have
been neglected since Al is small compared to 1.
...
area of cross-section 40 cm² that is prevented
from expanding while the temperature rises by
10 °C. The coefficient of linear expansion of steel
is al(steel) = 1.2 × 10-5 K-1. Thus, the compressive

strain is

Δι

· = &1(steel) ∆T= 1.2 × 105 × 10=1.2 × 104.
Youngs modulus of steel is Y = 2 × 1011 N m¯².
...
material of length a and breadth b (Fig. 10.8).
When the temperature increases by AT, a
increases by ∆a = aa∆T and b increases by Ab
= ab AT. From Fig. 10.8, the increase in area
ΔΑ = ΔΑ +ΔΑ + ΔΑ

ΔΑ = a∆b + b ∆a + (∆a) (Ab)

= aqb∆T+ ba₁ a ∆T + (a)² ab (AT)2

=

α₁ ab∆T(2 + α₁ ΔT) = α₁ ΑΔΤ(2 + α₁ ΔΤ)
Since a 10-5 K-1, from Table 10.1, the
product a₁ ATfor fractional temperature is small
...
Example 10.2 A blacksmith fixes iron ring
...
Example 10.1 Show that the coefficient of
area expansion, (AA/A)/AT, of a
...
time taken by using a stopwatch. You will find it
takes about twice the time and therefore, double
the quantity of heat required raising twice the
...
temperature by 20 °C, you will find the time taken
is again twice that required in the first step.
...
temperature, AT and the nature of substance.
...
where AQ is the amount of heat supplied to
...
If AQ stands for the amount of heat absorbed
or given off by a substance of mass m when it
undergoes a temperature change AT, then the
...
terms of moles μ, instead of mass m in kg, we
...
capacity of the substance. Like S, Calso
...
constant pressure and is denoted by C. On
...
volume and is denoted by C. For details see
Chapter 11. Table 10.3 lists measured specific
...
Initial temperature of aluminiumsphere=100 °C
...
sphere = m₁SA1∆T=0.047kg × SAL × 77 °C
...
Change in temperature (AT₂) = 23 °C – 20 °C = 3 °C
...
calorimeter = m2 sw ∆T₂ + m3scu∆T2

= (m2s + m3sc) (AT₂)

= (0.25 kg × 4.18 × 103 J kg-1 K-1 + 0.14 kg x

0.386 × 103 J kg¯¹ K-¹) (23 °C – 20 °C)
...
temperature and time (Fig. 10.9). You will observe
no change in the temperature as long as there
is ice in the beaker. In the above process, the
temperature of the system does not change even
though heat is being continuously supplied. The
heat supplied is being utilised in changing the
state from solid (ice) to liquid (water).

The change of state from solid to liquid is called
melting or fusion and from liquid to solid is called
freezing. It is observed that the temperature
remains constant until the entire amount of the
solid substance melts. That is, both the solid and
the liquid states of the substance coexist in
thermal equilibrium during the change of
states from solid to liquid. The temperature at
...
that temperature begins to rise (Fig.10.9). The
...
diagram on or P-T diagram. The following figure shows the phase diagram of water and CO2.
Such a phase diagram divides the P– Tplane into a solid-region, the vapour-region and the
...
to sublime. Dry ice (solid CO₂) sublimes, so also
...
J kg¹. The value of L also depends on the
...
fusion (L), and that for a liquid-gas state change
...
remains constant. Note in Fig. 10.12 that the
...
fusion and vaporisation are L₁ = 3.33 × 105 J kg-1
and L = 22.6 × 105J kg¯¹, respectively. That is,
3.33 × 105 J of heat is needed to melt 1 kg ice at
0 °C, and 22.6 × 105 J of heat is needed to convert
1 kg water into steam at 100°C. So, steam at
100°C carries_22.6×105Jkg-¹ more heat than
water at 100 °C. This is why burns from steam
are usually more serious than those from
boiling water.

Example 10.4 When 0.15 kg of ice at 0 °C
...
Fig. 10.12 Temperature versus heat for water at
...
Heat lost by water = ms (0–0)w
= (0.30 kg) (4186 J kg¯¹ K-¹) (50.0 °C – 6.7°C)
= 54376.14 J

Heat required to melt ice = m₂L₁ = (0.15 kg) L₁
Heat required to raise temperature of ice

water to final temperature = ms (0-0)1

= (0.15 kg) (4186 J kg-¹ K-¹) (6.7 °C – 0°C)
...
latent heat of fusion of ice, Lfice
...
Fig. 10.13 Heating by conduction, convection and
...
m sice AT₁ = = (3 (3 1 kg) (2100 J kg-1.
K-¹) [0-(-12)]°C = 75600 J
...
Consider a metallic bar of length Land uniform
...
distance from T to T; (T>T). The reservoir at
...
of flow of heat (or heat current) His proportional
to the temperature difference (T – T) and the
...
The constant of proportionality Kis called the
thermal conductivity of the material. The
greater the value of K for a material, the more
rapidly will it conduct heat. The SI unit of Kis
Js-1 m-1 K-1 or Wm-1 K-1. The thermal
conductivities of various substances are listed
in Table 10.6. These values vary slightly with
...
the Table 10.5. Heat retention and transfer are
...
other end = 0 °C. The area of cross section
of the steel rod is twice that of the copper
rod. (Thermal conductivity of steel
50.2 J s¯¹ m-1 K-1; and of copper
= 385 J s¯¹m¯¹ K-1).
...
Answer The insulating material around the rods
...
respectively. For A₁ = 2 A₂, L₁ = 15.0
L₂ = 10.0 cm, K₁
50.2 J s¯¹ m¯¹ K-1, K₁ = 385 c
s-1 m-1 K-1, we have
...
Example 10.7 An iron bar (L₁ = 0.1 m, A₁ =
79 W m¯¹ K-¹) and a
0.02 m², K
...
Given, L₁ = L₂= L = 0.1 m, A₁ = A₂= A= 0.02 m²
K₁ = 79 W_m-1 K-1, K₂ = 109 W m-1 K-1,
T₁ = 373 K, and T₂ = 273 K.

Under steady state condition, the heat
current (H) through iron bar is equal to the
heat current (H₂) through brass bar.
...
For A₁ = A₂ = A and L₁ = L₂ = L, this equation
...
Thus, the junction temperature T of the two
bars is
...
through the compound bar of length L₁ + L₂ = 2L
...
i.e., 3 x 108m s¯¹. You will learn these matters in
more detail later, but you now know why heat
...
Fig. 10.18: Energy emitted versus wavelength
for a blackbody at different
temperatures

m

Notice that the wavelength λ for which energy
is the maximum decreases with increasing
temperature. The relation between λ and Tis
...
is 2.9 × 10-3 m K. This law explains why the
...
maximum at λ = 4753 Å. This corresponds to
...
where A is the area and Tis the absolute
...
Boltzmann law and the constant ois called
...
lamp, for example, eis about 0.4. Thus, a tungsten
lamp at a temperature of 3000 K and a surface
area of 0.3 cm² radiates at the rate H = 0.3 x
10-4 x 0.4 x 5.67 × 10-8 × (3000)4 = 60 W.

A body at temperature T, with surroundings
at temperatures T, emits, as well as, receives
...
of a person's body is about 1.9 m² and the room
...
production by the body at rest (120 W). Το
...
Fig. 10.19 Curve showing cooling of hot water
with time.
...
∆T = (T2-T₁) of the body and the surroundings.
...
Suppose a body of mass mand specific heat
capacity s is at temperature T₂. Let T₁ be the
temperature of the surroundings. If the
temperature falls by a small amount dT, in time
...
Fig. 10.20(a). The set-up consists of a double-
...
temperatures T₂ of water in calorimeter and
T₁ of hot water in between the double walls,
...
a negative slope as shown in Fig. 10.20(b). This
...
is 50 °C above room temperature. Kis the same
...
### 2. A temperature-measuring device (thermometer) makes use of sor
...
### 3. The Celsius temperature (t) and the Farenheit temperare (t)are related by

t = (9/5) to + 32

### 4. The ideal gas equation connecting pressure (P), volume (V) and absolute temperature (7)

is :

PV = µRT

where u is the number of moles and Ris the universal gas constant.
...
absolute temperature scale (T) has the same unit size as the Celsius scale (T), but
...
6. The coefficient of linear expansion (a₁) and volume expansion (a) are defined by the
...
where Al and AV denote the change in length I and volume Vfor a change of temperature
AT. The relation between them is :
...
where m is the mass of the substance and AQ is the heat required to change its
temperature by AT. The molar specific heat capacity of a substance is defined by
...
where u is the number of moles of the substance.

8. The latent heat of fusion (L) is the heat per unit mass required to change a substance
from solid into liquid at the same temperature and pressure. The latent heat of
vaporisation (L) is the heat per unit mass required to change a substance from liquid
...
molecular collisions, without any flow of matter. For a bar of length Land uniform
...
11. Newton's Law of Cooling says
...
10.1 The triple points of neon and carbon

dioxide are 24.57 K and 216.5

216.55 K respectively.
...
The absolute temperature (Kelvin scale) Tis related to the temperature to on
...
A steel tape 1m long is correctly calibrated for a temperature of 27.0 °C. The length
...
? Coefficient of linear expansion of steel = 1.20 × 10-5 K¯¹ .
...
of brass = 2.0 × 10-5 K¯¹; Young's modulus of brass = 0.91 × 1011 Pa.
...
brass = 2.0 × 10-5 K¯¹, steel = 1.2 × 105־ K¯¹(.

10.11 The coefficient of volume expansion of glycerine is 49 × 10-5 K¯¹. What is the fractional
...
Specific heat of aluminium = 0.91 J g¯¹ K¯¹.
...
melt? (Specific heat of copper = 0.39 J g¯¹ K-1; heat of fusion of water
= 335 J g¯¹).
...
150 cm³ of water at 27 °C. The final temperature is 40 °C. Compute the specific heat
...
conductivity of thermacole is 0.01 J s¯¹ m-1 K-1. [Heat of fusion of water = 335 × 103
Jkg-1]

2018 m. [Heat of fusion of w

kness

10.18 A brass boiler has a base area of 0.15 m² and thickness 1.0 cm. It boils water at the
rate of 6.0 kg/min when placed on a gas stove. Estimate the temperature of the part
of the flame in contact with the boiler. Thermal conductivity of brass = 109 J s¯¹ m¯¹
...
heating systems based on circulation of steam are more efficient in warming
