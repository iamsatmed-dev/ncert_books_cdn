# NCERT: 11TH_CHEMISTRY_CH07_REDOX_REACTIONS_CH07_REDOX_REACTIONS_EN
> **Total Pages**: 21 | **Digitized via**: Google Document AI OCR
...
In reactions (7.1) and (7.2), the elements
...
2K4 [Fe(CN)](aq) + H₂O₂ (aq) →2K3[Fe(CN)](aq)
+ 2 KOH (aq)
...
electropositive element to a substance._
...
2HgCl₂ (aq) + SnCl2 (aq) → Hg2Cl2 (s)+SnCl4 (aq)
(7.11)
...
(i) H₂S is oxidised because a more
...
written as Na+Cl- (s), (Na+)₂O2-(s), and (Na+)2
S2-(s). Development of charges on the species
...
by passing HS gas through the solution to
...
Ni2+(aq) and Co²+(aq) are present at moderate
...
neutral (zero) state in H₂ to a positive state in
H₂O, the O atom goes from a zero state in O₂
to a dinegative state in H₂O. It is assumed that
there is an electron transfer from H to O and
consequently H₂ is oxidised and O₂ is reduced.
...
CH₄(g) + 4Cl2(g) → CCl4 (1) + 4HCl(g) (7.20)
...
in a covalent bond belongs entirely to more
...
Na2S2O3/Cr2O2-, the oxidation number of the
atom of that element will then be the average
...
Clion, -1, 02- ion, −2; and so on. In their
compounds all alkali metals have oxidation
...
compounds is -2. However, we come
...
each other. While in peroxides (e.g., H2O2,
Na2O2), each oxygen atom is assigned an
oxidation number of −1, in superoxides
(e.g., KO2, RbO₂) each oxygen atom is
assigned an oxidation number of –(1/2).
The second exception appears rarely, i.e.
when oxygen is bonded to fluorine. In
such compounds e.g., oxygen difluoride
(OF₂) and dioxygen difluoride (O2F₂), the
oxygen is assigned an oxidation number
of +2 and +1, respectively. The number
assigned to oxygen will depend upon the

bonding state of oxygen but this number
would now be a positive figure only.
...
and CaH2, its oxidation number is −1.
...
below in the compounds of the elements.
...
and similarly the oxidation state as well
as oxidation number of oxygen is 2. This
...
stannic chloride are written as Sn(II)Cl₂ and
Sn(IV)Cl. This change in oxidation number
...
Thus, Hg2(I)Cl, is the reduced form of Hg(II) Cl2.

Problem 7.3

Using Stock notation, represent the
following compounds :HAuCl4, T1₂O, FeO,
Fe2O3, Cul, CuO, MnO and MnO2.
Solution
...
HAu(III)C14, T12(I)O, Fe(II)O, Fe2(III)O3,
...
Further, Cu₂O helps sulphur in Cu₂S to
increase its oxidation number, therefore,
Cu(I) is an oxidant; and sulphur of Cu₂S
helps copper both in Cu₂S itself and
Cu₂O to decrease its oxidation number;
therefore, sulphur of Cu₂S is reductant.
...
in reaction (7.28). This may also be noted
...
metal displacement redox reactions include
...
that the metals – zinc (Zn), copper (Cu) and
silver (Ag) through tendency to lose electrons
show their reducing activity in the order Zn>

Cu>Ag. Like metals, activity series also exists
...
(aq) →
(7.42)
As Br2 and I₂ are coloured and dissolve in CC14,
...
Cl₂ (g) + 2Br (aq) → 2Cl (aq) + Br2 (1) (7.41a)
...
Brand I, as fluorine is the strongest oxidising
...
agent; there is no way to convert F- ions to F
by chemical means. The only way to achieve
F₂ from F is to oxidise electrolytically, the
...
2 F2(g) + 2OH-(aq) → 2 F~(aq) + OF2(g) + H₂O(1)
(7.49)
...
above, ClO does not disproportionate
...
In reaction (a), the compound nitric
oxide is formed by the combination of
...
decomposition redox reaction. In

reaction (c), hydrogen of water has been
displaced by hydride ion into dihydrogen
gas. Therefore, this may be called as
displacement redox reaction. The reaction
(d) involves disproportionation of NO,
(+4 state) into NO₂ (+3 state) and NO
...
Br3O [where oxidation number of bromine is (16/3)]

8

and Na2SO (where oxidation number of sulphur is 2.5).

electrons

We know that the idea of fractional oxidation number is unconvincing to us,
...
Structure of the species C₃O₂, Br3O, and S₄O- reveal the following bonding situations:
...
Structure of Br3O (tribromooctaoxide)
...
This reveals that in CO2, two carbon atoms are present in +2 oxidation state each, whereas
the third one is present in zero oxidation state and the average is 4/3. However, the realistic
picture is +2 for two terminal carbons and zero for the middle carbon. Likewise in Br₂O, each
...
16/3. In the same fashion, in the species S₄O2-, each of the two extreme sulphurs exhibits oxidation
state of +5 and the two middle sulphurs as zero. The average of four oxidation numbers of sulphurs
of the SO2 is 2.5, whereas the reality being + 5,0,0 and +5 oxidation number respectively for
each sulphur.
...
Pb3O4 + 8HCl → 3PbCl2 + Cl2 + 4H2O_and
...
Pb3O4 is actually a stoichiometric
...
agent) and, therefore, can oxidise Cl- ion
...
PbO2 + 4HCl → PbCl2 + Cl₂ +2H2O
(redox reaction)

Since HNO3 itself is an oxidising agent
therefore, it is unlikely that the reaction
may occur between PbO2 and HNO3.
However, the acid-base reaction occurs
between PbO and HNO3 as:

2PbO + 4HNO3 → 2Pb(NO3)2 + 2H₂O
It is the passive nature of PbO2 against
HNO3 that makes the reaction different
...
equal by adding water (H₂O) molecules to the
...
K2Cr2O, with sodium sulphite, Na2SO3,
...
add 8H+ on the left to make ionic charges
equal

Cr2O2-(aq) + 3SO32-(aq)+ 8H+→ 2Cr³+(aq)
+ 3SO42- (aq)
...
Cr2O2 (aq) + 3SO32- (aq)+ 8H+ (aq) →
2Cr3+ (aq) + 3SO42- (aq) +4H2O (1)

Problem 7.9

Permanganate ion reacts with bromide
...
2MnO₄(aq)+Br(aq) → 2MnO2(s)+BrO3(aq)
Step 4: As the reaction occurs in the
basic medium, and the ionic charges are
not equal on both sides, add 2 OH¯ ions
on the right to make ionic charges equal.
2MnO (aq) + Br¯ (aq) → 2MnO2(s) +

BrO3(aq) + 2OH-(aq)

Step 5: Finally, count the hydrogen atoms
and add appropriate number of water
molecules (i.e. one H₂O molecule) on the
left side to achieve balanced redox change.
2MnO (aq) + Br¯(aq) + H2O(l) → 2MnO2(s)
+ BrO3 (aq) + 2OH-(aq)
...
by dichromate ions (Cr2O7)²- in acidic medium,
wherein, Cr2O32- ions are reduced to Cr³+ ions.
The following steps are involved in this task.
Step 1: Produce unbalanced equation for the
reaction in ionic form :

Fe2+(aq) + Cr2O2- (aq) → Fe3+ (aq) + Cr³+(aq)
...
Oxidation half : Fe2+ (aq) → Fe³+(aq)

+6-2

+3

Reduction half : Cr₂O2-(aq) → Cr3+(aq)
...
oxidation half reaction is already balanced
with respect to Fe atoms. For the reduction
half reaction, we multiply the Cr³+ by 2 to
balance Cr atoms.
...
Cr2O2 (aq) + 14H+ (aq) → 2 Cr³+(aq) + 7H₂O (1)
(7.54)
...
6Fe2+(aq) + Cr2O2-(aq) + 14H+(aq) → 6 Fe³+(aq) +
...
balanced with respect to number of atoms
and the charges.

For the reaction in a basic medium, first
balance the atoms as is done in acidic medium.
Then for each H+ ion, add an equal number of
OH- ions to both sides of the equation. Where
H+ and OH- appear on the same side of the
equation, combine these to give H₂O.

Problem 7.10

Permanganate(VII) ion, MnO in basic
solution oxidises iodide ion, I- to produce
molecular iodine (I₂) and manganese
...
First we write the skeletal

ionic equation, which is
MnO (aq) + I- (aq) → MnO2(s) + I2(s)
...
Oxidation half : I-(aq) → I₂ (s)

+7

+4

Reduction half: MnO(aq) → MnO2(s)
...
add four OH- ions to both sides of the
equation:
...
MnO (aq) + 2H2O (l) → MnO2 (s) + 4 OH¯ (aq)
Step 5: In this step we balance the
charges of the two half-reactions in the
manner depicted as:

2I- (aq) → I₂ (s) + 2e-
MnO(aq) + 2H2O(l) + 3e¯ → MnO2(s)
...
61-(aq) + 2MnO₄(aq) + 4H2O(l) → 312(s) +
2MnO2(s) +8 OH-(aq)
Step 7: A final verification shows that
the equation is balanced in respect of
the number of atoms and charges on
both sides.

7.3.3 Redox Reactions as the Basis for
Titrations

In acid-base systems we come across with a
titration method for finding out the strength
of one solution against the other using a
pH sensitive indicator. Similarly, in redox
...
ion, MnO. Here MnOī acts as the self
indicator. The visible end point in this case
is achieved after the last of the reductant
(Fe2+ or C2O42-) is oxidised and the first
lasting tinge of pink colour appears at
MnO concentration as low as 10-6 mol dm-³
(10-6 mol L-¹). This ensures a minimal
...
best example is afforded by Cr2O2-, which
...
thiosulphate ions (S₂O₃²¯), which too is a redox
...
I₂(aq) + 2 S₂O3(aq)→2I¯(aq) + S₄O‰²¯(aq) (7.60)
I₂, though insoluble in water, remains in
...
7.3.4 Limitations of Concept of Oxidation
Number
...
7.4 REDOX REACTIONS AND ELECTRODE
PROCESSES

The experiment corresponding to reaction
(7.15), can also be observed if zinc rod is
...
reaction, zinc is oxidised to zinc ions and
...
set-up for Daniell cell. Electrons
...
are represented as_Zn2+/Zn_and_Cu2+/Cu.
...
### 1. The transfer of electrons now does not
...
reducing agent than the H+/H₂ couple. A
...
Ions are present as aqueous species and H₂O as liquid; gases and
...
_ Increasing strength of reducing agent
...
(f) NaBH4 (g) H2S2O7 (h) KAl(SO4)2.12

What are the oxidation number of the underlined elements in each of the following
...
(a) CuO(s) + H2(g) → Cu(s) + •H₂O(g)

(b) Fe2O3(s) + 3CO(g) → 2Fe(s) + 3CO2(g)

(c) 4BC1(g) + 3LiAlH₄(s) → 2B2(g) + 3LiCl(s) + 3 AlCl3 (s)
...
Calculate the oxidation number of sulphur, chromium and nitrogen in H2SO5, Cr2O2-
...
Suggest a list of the substances where carbon can exhibit oxidation states from -4
...
(b) O3(g) + H₂O2(l) → H2O(l) + 2O2(g)

Why it is more appropriate to write these reactions as :

(a) 6CO2(g) + 12H₂O(l) → C6H12O(aq) + 6H2O(l) + 602(g)

(b) O3(g) + H₂O₂(1) → H2O(l) + O2(g) + O2(g)
...
The compound AgF, is unstable compound. However, if formed, the compound acts
as a very strong oxidising agent. Why?

7.11

Whenever a reaction between an oxidising agent and a reducing agent is carried out,
...
Identify the substance oxidised reduced, oxidising agent and reducing agent for
each of the following reactions:

(a) 2AgBr (s) + CHO₂(aq) 2Ag(s) + 2HBr (aq) + CHO₂(aq)

(b) HCHO(l) + 2[Ag (NH3)2]+(aq) + 3OH-(aq) 2Ag(s) + HCOO-(aq) + 4NH3(aq)

+ 2H2O(1)

(c) HCHO (1) + 2 Cu2+(aq) + 5 OH-(aq) Cu2O(s) + HCOO-(aq) + 3H2O(l)

(d) N₂H₄(1) + 2H2O2(l) → N₂(g) + 4H2O(l)

(e) Pb(s) + PbO2(s) + 2H2SO4(aq) → 2PbSO₄(s) + 2H2O(l)
...
S2O3(aq) + 2Br2(l) + 5 H2O(l) → 2SO-(aq) + 4Br¯(aq) + 10H+(aq)
...
XeO + (aq) + 2F¯ (aq) + 6H+(aq) → XeO3(g)+ F2(g) + 3H2O(l)

What conclusion about the compound Na XeO (of which XeO is a part) can be
...
(a) H3PO2(aq) + 4 AgNO3(aq) + 2 H2O(l) → H₃PO₄(aq) + 4Ag(s) + 4HNO3(aq)
(b) H3PO2(aq) + 2CuSO4(aq) + 2 H2O(l) → H₃PO₄(aq) + 2Cu(s) + H₂SO₄(aq)
(c) CHCHO(l) + 2[Ag (NH3)2]+(aq) + 3OH-(aq) → CH₂COO-(aq) + 2Ag(s) +

(d) CHCHO(l) + 2Cu2+(aq) + 5OH-(aq) → No change observed.
...
MnO2 (s) + I₂(s) (in basic medium)
Mn2+ (aq) + HSO4 (aq) (in acidic solution)

7.19

(c) H₂O₂ (aq) + Fe2+ (aq) → Fe3+ (aq) + H2O (l) (in acidic solution)

(d) Cr₂O2 + SO2(g) → Cr3+ (aq) + SO42- (aq) (in acidic solution)

Balance the following equations in basic medium by ion-electron method and
oxidation number methods and identify the oxidising agent and the reducing agent.

(a) P₄(s) + OH-(aq) → PH₃(g) + HPO₂ (aq)

(b) N₂H₄(1) + ClO3(aq) → NO(g) + Cl-(g)

7.20

(c) Cl₂O, (g) + H₂O₂(aq) → ClO2(aq) + O2(g) + H+
...
The Mn³+ ion is unstable in solution and undergoes disproportionation to give Mn2+,
...
Chlorine is used to purify drinking water. Excess of chlorine is harmful. The excess
...
In Ostwald's process for the manufacture of nitric acid, the first step involves the
...
Arrange the following metals in the order in which they displace each other from
