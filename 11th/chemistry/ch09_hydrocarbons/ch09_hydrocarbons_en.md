# NCERT: 11TH_CHEMISTRY_CH09_HYDROCARBONS_CH09_HYDROCARBONS_EN
...
get C2H6. This hydrocarbon with molecular
...
the general formula for alkanes is CnH2n+2. It
...
You have already read that C–C and C–Η σ
...
molecular formula C6H14. Also write their
IUPAC names.
...
(b) CH3-CH2-CH2-CH - CH - °C -2CH2-CH3
...
(c) 'CH3-CH2-CH2-*CH-CH-CH2-CH2-CH2-CH2-CH3
...
by putting requisite number of hydrogen
...
Numbering is to be started from the
...
CH3CH2CH2C1 + H₂ _Zn,H* → CH3CH2CH3+CH1
1-Chloropropane
...
CH3Br+2Na+BrCH3 _dry ether → CH3+2Na
Bromomenthane
...
alkane containing even number of
...
Sodium salts of carboxylic acids on
heating with soda lime (mixture of sodium
...
four members, C₁ to C4 are gases, C5 to C17
...
generally observed that in relation to solubility
...
reducing agents. However, they undergo
the following reactions under certain
conditions.
...
alkanes with halogens is F₂ > Cl₂ > Br₂ > I2.
...
(i) Initiation : The reaction is initiated
by homolysis of chlorine molecule in the
presence of light or heat. The Cl-Cl bond
...
During incomplete combustion of alkanes
with insufficient amount of air or dioxygen,
carbon black is formed which is used in
...
CH2(g) + O2(g) incomplete C(s)+2H2 O(1)
...
Alkanes on heating with a regulated supply
...
(i) 2CH4 + O2 Cu/523K/100atm > 2CH3 OH
...
(iii) 2CH3CH3 + 302 (CH3COO)Mn, 2CH3COOH
...
generally not reported in organic reactions.

CH3(CH)2)4CH3 Anhy, AICI3/ HCI
...
CH3CH−(CH2)2−CH₃+CH3CH2-CH-CH2-CH3 example, dodecane, a constituent of kerosene
...
energy barrier of 1-20 kJ moľ¯¹ due to weak
...
along the molecular axis. It is then projected
on paper by drawing the central C–C bond
...
corresponding to three hydrogen atoms.
...
kJ moľ¯¹, which is very small. Even at ordinary
...
the first member, ethylene or ethene (C2H4)
was found to form an oily liquid on reaction
with chlorine.
...
overlapping of sp² hybridised orbitals and
...
The presence of weaker a-bond makes alkenes
...
Orbital picture of ethene depicting
σ bonds only
...
CH2 = CH – H-CH-CH33-Methylbut-1-ene
...
In (a), the two identical atoms i.e., both
the X or both the Y lie on the same side
of the double bond but in (b) the two X or
two Y lie across the double bond or on the
opposite sides of the double bond. This
results in different geometry of (a) and (b) i.e.
...
type
type 
are called geometrical isomers. The
...
other isomer of the type (b), in which identical
atoms or groups lie on the opposite sides of
the double bond is called trans isomer. Thus
cis
cis 
and trans isomers have the same structure
...
### 2. From alkyl halides: Alkyl halides (R-X) on
heating with alcoholic potash (potassium
...
iv) CH3-C= CH+H2 Pd/C → CH3–CH =CH2
...
that in the trans-but-2-ene, the two methyl
groups are in opposite directions, Threfore,
dipole moments of C-CH3 bonds cancel, thus
...
ethanol) eliminate one molecule of halogen
acid to form alkenes. This reaction is
known as dehydrohalogenation i.e.,
removal of halogen acid. This is example
of ẞ-elimination reaction, since hydrogen
atom is eliminated from the ẞ carbon atom
...
ẞ-elimination reaction since –OH group
...
### 1. Addition of dihydrogen: Alkenes add

up one molecule of dihydrogen gas in
the presence of finely divided nickel,
...
halides (HCl, HBr,HI) add up to alkenes
to form alkyl halides. The order of
...
Addition reaction of HBr to symmetrical symmetrical
...
Hydrogen bromide provides an electrophile,
H+, which attacks the double bond to form
...
(ii) The carbocation (b) is attacked by Brion
...
How will Η Br add to propene ? The two
...
Mechanism : Peroxide effect proceeds via
...
(iv) CH3–CH-CH2Br + H− Br_Homolysis

CH₃ – CH₂ – CH,Br + Br
(major product)

(v) CH3–CH- CH₂ + H- Br Homolysis
...
to the fact that the H-C1 bond being
stronger (430.5 kJ moľ¯¹) than H-Br bond
...
(CH3)2C=CH2 KMnO4/H (CH3)2C=O + CO2+H2O
2-Methylpropene
...
monomers. Other alkenes also undergo
polymerisation.

Catalyst

n(CH2=CH2) High temp./pressure, (CH2-CH2 +
Polythene
(9.53)

n(CH3-CH=CH2) High temp./pressure,
...
Polymers are used for the manufacture of plastic
bags, squeeze bottles, refrigerator dishes, toys,
pipes, radio and T.V. cabinets etc. Polypropene
...
with molecular formula C5H8? Let us try to
arrange five carbon atoms with a continuous
...
Structures I and II are position isomers
and structures I and III or II and III are chain
isomers.
...
corresponding to the 5th member of
alkyne series. Also write IUPAC names of
all the isomers. What type of isomerism
is exhibited by different pairs of isomers?
Solution

5th member of alkyne has the molecular
...
πbonds. The strength of C=Cbond (bond
enthalpy 823 kJ mol¹) is more than those
of C=C bond (bond enthalpy 681 kJ mol¹)
and C-C bond (bond enthalpy 348 kJ moľ¹).
The C=C bond length is shorter (120 pm)
than those of C=C (133 pm) and C-C (154
...
metal and sodamide (NaNH2) are strong
bases. They react with ethyne to form sodium
acetylide with the liberation of dihydrogen
...
and the hybridisation? You have read that
hydrogen atoms in ethyne are attached to
...
the sp hybridised carbon atoms whereas
they are attached to sp² hybridised carbon
atoms in ethene and sp³ hybridised carbons
in ethane. Due to the maximum percentage of
s character (50%), the sp hybridised orbitals
...
(9.59)
HC=C¯Na + Na → Na⁺C¯Na*=C¯Na*+ =C¯Na*+ 1/2H2
...
i) _CH = CH > H₂C −CH2 > CH3-CH3

ii)_HC = CH > CH3 –C= CH >> CH3–C=C-CH3
...
HC=CH+H2 Pt/Pd/Ni, [H2C=CH2] _H2 CH3–CH3

CH3-C≡CH + H₂ Pt/Pd/Ni¸ [CH3–CH=CH2]
...
polyethyne which is a high molecular
...
(b) Cyclic polymerisation: Ethyne on
...
but in a majority of reactions of aromatic
...
the presence of three double bonds. Benzene
...
the bromine atoms are attached to the
...
The unhybridised porbital of carbon atoms
are close enough to form a n bond by lateral
overlap. There are two equal possibilities of
forming three a bonds by overlap of p orbitals
of C1-C2, C3 – C4, C5 – C6 or C2 – C3, C4 – C5,
C6 - C₁ respectively as shown in the following
own
figures.
...
each carbon atom overlaps with s orbital
of a hydrogen atom to form six C—H sigma
bonds. Each carbon atom is now left with one
...
Structures shown in Fig. 9.7(a) and (b)
...
been determined by the X-ray diffraction to
...
The six n electrons are thus delocalised
and can move freely about the six carbon
nuclei, instead of any two as shown in
Fig. 9.6 (a) or (b). The delocalised nelectron cloud
...
(i) Nitration: A nitro group is introduced
...
the presence of anhydrous AlCl3 can be
chlorinated to hexachlorobenzene (CCl)

+ 6Cl2 dark, cold

Cl

(iii) CH-C-Cl + AlCl → CH3-C+ [AIC14]

+

In the case of nitration, the electrophile,
nitronium ion, NO₂ is produced by transfer of
...
RCO (acylium ion) respectively by combining
...
2
9.5.6 Directive influence of a functional
...
hexachloride, C«H«Cl6 which is also called
gammaxane.
...
burns with sooty flame producing CO2 and
H₂O
15
CH6 +
2
...
structures that the electron density is more on
o-and p-positions. Hence, the substitution
takes place mainly at these positions. However,
it may be noted that -I effect of – OH group also
operates due to which the electron density on
ortho and para positions of the benzene ring
...
groups are –NH2, –NHR, –NHCOCH3, −OCH3,
-CH3, C2H5, etc.
...
resonance the electron density on o- and
p- positions is greater than that at the
m-position. Hence, they are also o- and p-
directing groups. Resonance structures of
chlorobenzene are given below:
...
In this case, the overall electron density
on benzene ring decreases making further
substitution difficult, therefore these groups
are also called ‘deactivating groups'. The
electron density on o- and p- position
is comparatively less than that at meta
position. Hence, the electrophile attacks on
...
(g) CH3– 3- CH CH = = CH CH – – CH, CH2 – CH = CH – CH – CH2 – CH =
...
For the following compounds, write structural formulas and IUPAC names for all
...
An alkene 'A' contains three C – C, eight C – Η σ bonds and one C – C π
...
Propanal and pentan-3-one are the ozonolysis products of an alkene? What

is the structural formula of the alkene?

9.8

Write chemical equations for combustion reaction of the following
...
Addition of HBr to propene yields 2-bromopropane, while in the presence
