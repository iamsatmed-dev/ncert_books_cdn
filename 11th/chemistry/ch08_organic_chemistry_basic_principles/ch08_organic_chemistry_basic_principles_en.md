# NCERT: 11TH_CHEMISTRY_CH08_ORGANIC_CHEMISTRY_BASIC_PRINCIPLES_CH08_ORGANIC_CHEMISTRY_BASIC_PRINCIPLES_EN
...
ethene (C₂H₄), ethyne (C₂H₂) are explained
in terms of the use of sp³, sp² and sp hybrid
...
the sp³ hybrid orbital. The sp² hybrid orbital
is intermediate in s character between sp
and sp³ and, hence, the length and enthalpy
...
that possessing sp² or sp³ hybridised orbitals.
...
Thus, in H₂C=CH2 molecule all the atoms
...
Rotation of one CH₂ fragment with respect
...
reagents. In general, a bonds provide the most
reactive centres in the molecules containing
multiple bonds.

Problem 8.1

How many σ and a bonds are present in
each of the following molecules?

(a) HC=CCH=CHCH3 (b) CH2=C=CHCH3
Solution

(a) σc-c: 4; 6C-H : 6; πc=c :1; π C=C:2
...
(a) CH3Cl, (b) (CH₃)₂CO, (c) CH₃CN,
(d) HCONH₂, (e) CH3CH=CHCN
Solution

(a) sp³, (b) sp³, sp², (c) sp³, sp, (d) sp², (e)
sp³, sp², sp², sp
...
not be shown. Thus, ethane (C₂H₂), ethene
(C₂H₄), ethyne (C₂H₂) and methanol (CH3OH)
...
can be further condensed to CH3(CH2)CH3.
...
The functional group is an atom or a group
of atoms joined to the carbon chain which is
...
formula by a –CH, unit. There are a number
...
groups. This gives rise to polyfunctional polyfunctional
compounds.
...
given to the newly discovered C60 cluster (a
form of carbon) noting its structural similarity
...
Common or Trivial Names of Some
Organic Compounds
...
number of -CH, groups in the chain. They are
homologues of alkane series.

Table 8.2 IUPAC Names of Some Unbranched
...
a hydrogen atom from carbon. Thus, CH
becomes -CH, and is called methyl group. An
...
We also encounter the structural unit,
...
2 3 4 5 6 7 8 9
CH3-CH-CH2-CH2CH2CH-CH2-CH2-CH3
...
CH3-CH-CH2-CH2CH=CH-CH2-CH2-CH3
...
numbered to identify the parent alkane
...
of hydrogen atoms. The numbering is
done in such a way that the branched
carbon atoms get the lowest possible
numbers. Thus, the numbering in the
above example should be from left to right
(branching at carbon atoms 2 and 6) and
not from right to left (giving numbers
4 and 8 to the carbon atoms at which
...
### 4. If two or more identical substituent
...
CH3-CH-CH2-CH-CH, CH-C-CH-CH-CH
...
equivalent positions, the lower number
is given to the one coming first in the
...
6. The branched alkyl groups can be
named by following the above mentioned
procedures. However, the carbon atom
of the branch that attaches to the root
...
After selection of the chain, numbering
...
in equivalent position; lower number is
...
CH3OH, CH3CH2OH, and (CH3)2CHOH
all having -OH functional group liberate
...
possessing these are given in Table 8.4.
...
given in Table 8.4, the name of the compound
is arrived at.

In the case of polyfunctional compounds,
one of the functional groups is chosen as the
principal functional group and the compound
...
-COOH, -SO3H, -COOR (R=alkyl group), COCI,
-CONH₂, -CN,-HC=O, >C=O, -OH, -NH2, >
C=C<, -C=C- .

The -R, CH-, halogens (F, Cl, Br, I), –NO2,
...
For example, HOCH2(CH2)2CH2COCH3 will
be named as 7-hydroxyheptan-2-one and not
as 2-oxoheptan -7-ol. Similarly, BrCH2CH=CH2
...
class suffix. In such cases the full name of the
parent alkane is written before the class suffix.
For example CH2(OH)CH2(OH) is named as
...
The longest chain containing -OH
has eight carbon atoms. Hence the
corresponding saturated hydrocar-
bon is octane.
...
of two keto groups is indicated by 'di',
...
carbon of COOH functional group.
...
The two_C=C functional groups are
...
carbon-carbon double bond is implied
...
functional group whereas NO₂ is prefixed
functional group therefore double bond
gets preference over –NO₂ group:
...
is su
group and gets preference over_C=C
...
formula of the compound is: CH3CH(OH)
CH2CH2CH2CH2CHO. Carbon atom of
...
placed as prefix to the word benzene as shown
...
the terms ortho (o), meta (m) and para (p)
...
and the compounds are named by identifying
...
alkane with a functional group, it is considered
as substituent, instead of a parent. The name
...
as isomerism. Such compounds are called
...
in which atoms are linked) are classified as
...
molecular formula CHO represents two
alcohols:

(2,2-Dimethylpropane) d
...
formula CHO represents an aldehyde and
a ketone:
...
knowledge of reaction mechanism helps
...
pair and a negative charge. Thus, heterolytic
cleavage of bromomethane will give CH, and
...
ion). The CH ion is known as a methyl cation
...
carbocations are: CH₂CH₂ (ethyl cation, a
primary carbocation), (CH₃)₂CH (isopropyl
cation, a secondary carbocation), and (CH₃)₃Č
(tert-butyl cation, a tertiary carbocation).
Carbocations are highly unstable and
...
is: CH₃ < CH₂CH₂ < (CH₃)₂CH < (CH) C. These
carbocations have trigonal planar shape
with positively charged carbon being sp²
hybridised. Thus, the shape of CH, may be
considered as being derived from the overlap
of three equivalent C(sp²) hybridised orbitals
...
species in which carbon gets the shared
pair of electrons. For example, when group
Z attached to the carbon leaves without
...
electron pair, the methyl anion H3
...
sp³ hybridised and its structure is distorted
tetrahedron as shown in Fig. 8.3(b).
...
is shown by 'half-headed' (fish hook:~)

curved arrow. Such cleavage results in
...
Ions are generally not formed in the reactions
...
reactive site) e.g., an atom with incomplete
...
which can supply electrons, e.g., πelectrons
in a double bond.
...
nucleophile attacks an electrophilic centre
...
carbanions (RC:-). Neutral molecules such
as H₂O:, RN:, R₂NH etc., can also act as
nucleophiles due to the presence of lone
pair of electrons. Examples of electrophiles
include carbocations (ČḤ) and neutral
molecules having functional groups like
carbonyl group (>C=O) or alkyl halides
(RC-X, where X is a halogen atom). The
...
on the carbon atom and hence the carbon
atom becomes an electrophilic centre at which
a nucleophile can attack.
...
Nucleophiles: HS¯,C2H5O¯,(CH3)3N:H₂N:¯
...
notation. It shows how changes in bonding
...
(ii) Y__ÿ_ from a bond to
adjacent atom

(iii)

←→-ү= from atom to adjacent
bond position
...
carbon-1 gains some positive charge (8+)
and the chlorine some negative charge (d¯).
The fractional electronic charges on the two
atoms in a polar covalent bond are denoted
by symbol 8 (delta) and the shift of electron
...
when a reagent approaches to attack it.
...
nitro (- NO₂), cyano (- CN), carboxy (- COOH),
ester (COOR), aryloxy (-OAr, e.g. – OCH｡), etc.
are electron-withdrawing groups. On the other
hand, the alkyl groups like methyl (–CH3) and
...
pairs of molecules: (a) HC-H, HC-Br
(b) HC-NH2, HC-OH (c) HC-OH,
HC-SH
...
behaviour cannot be explained by a single Lewis
structure. An example is that of
benzene. Its cyclic structure
containing alternating C-C single
and C=C double bonds shown
is inadequate for explaining its Benzene
characteristic properties.

As per the above representation, benzene
should exhibit two different bond lengths,
due to C-C single and C=C_double bonds.
However, as determined experimentally
benzene has a uniform C-C bond distances
of 139 pm, a value intermediate between the
C-C single(154 pm) and C=C_double (134
...
Therefore, according to the resonance
theory (Unit 4) the actual structure of

benzene cannot be adequately represented
by any of these structures, rather it is
a hybrid of the two structures (I and II)
called resonance structures. The resonance
structures (canonical structures or
contributing structures) are hypothetical
...
by nitromethane (CH₃NO₂) which can be
represented by two Lewis structures, (I and
...
structure of nitromethane is therefore
a resonance hybrid of the two canonical
forms I and II.

The energy of actual structure of the molecule
(the resonance hybrid) is lower than that of
any of the canonical structures. The difference
in energy between the actual structure and the
...
of important contributing structures, the
...
CH2=CH-CHO. Indicate relative stability
...
separation. Additionally, structure
...
mesomeric effect designated as Ror M effect.
...
represent +R_or –R electron displacement
effects are as follows:

+Reffect: – halogen, –OH, –OR, –OCOR, –NH2,
–NHR, –NR2, –NHCOR,
...
double bonds in an open chain or cyclic system
is termed as a conjugated system. These
systems often show abnormal behaviour.
The examples are 1,3- butadiene, aniline
and nitrobenzene etc. In such systems, the
π-electrons are delocalised and the system
develops polarity.

8.7.8

Electromeric Effect (E effect)
It is a temporary effect. The organic compounds
having a multiple bond (a double or triple
bond) show this effect in the presence of
...
p orbital. The o electrons of C-H bond of the
...
us take an example of CH, CH₂ (ethyl cation) in
which the positively charged carbon atom has
...
this effect the n-electrons of the multiple
...
the adjacent o bond helps in dispersing the
positive charge.
...
Fig. 8.4(b) Orbital diagram showing
...
Explain why (CH) is more stable
than CH₂CH₂ and ĊHis the least stable
...
Hyperconjugation interaction in (CH₃)₂Ċ iş
greater than in CH₂CH₂ as the (CH₃)₂C
has nine C-H bonds. In ČH, vacant p
orbital is perpendicular to the plane
in which C-H bonds lie; hence cannot

3

overlap with it. Thus, CH, lacks
...
and (ii) the liquids having sufficient difference
in their boiling points. Liquids having
...
Fractional Distillation: If the difference
in boiling points of two liquids is not much,
simple distillation cannot be used to separate
...
Fig.8.6 Fractional distillation. The
...
pressures due to the organic liquid (p₁)
and that due to water (p₂) becomes equal to
the atmospheric pressure (p), i.e. p =p₁+ P₂
Since p₁ is lower than p, the organic liquid
vaporises at lower temperature than its
boiling point.
...
that different compounds are adsorbed on
...
Fig.8.10 Differential extraction. Extraction of com-
...
The glass plate is then placed in a closed jar
...
visible on TLC plate due to their original colour.
...
different heights from the position of initial
...
separated colourless compounds may be
observed either under ultraviolet light or by
...
are carbon and hydrogen. In addition to
these, they may also contain oxygen, nitrogen,
...
C, N, Sand X come from organic compound.
...
6CN- + Fe2+ → [Fe(CN)]+
3[Fe(CN)] + 4Fe3+ H2O Fe4[Fe(CN)6]3.xH2O
...
a violet colour further indicates the
presence of sulphur.
...
U-tube containing anhydrous calcium chloride.
...
mg, mass of water and carbon dioxide
produced be m₁ and m g respectively;
Percentage of carbon= 12×m2×100
...
volume of nitrogen, p₁ is different from the
atmospheric pressure at which nitrogen gas
is collected. The value of p₁ is obtained by
the relation;
...
copper(II) oxide in the presence of CO2 gas.
of gases is collected over
potassium hydroxide solution in which CO₂ is absorbed and volume of nitrogen
gas is determined.

2

V mL N₂ at STP weighs
...
Fig.8.16 Kjeldahl method. Nitrogen-containing compound is treated with concentrated H₂SO₄ to get
...
Organic compound + H₂SO₄ → (NH4)2SO4
2NaOH → Na2SO4 + 2NH3 + 2H₂O

2NH3 + H₂SO₄ → (NH4)2SO4

Percenta

of N = 14×M×2(V - V₁/2)×100
...
Let the mass of organic compound taken = mg compo
Volume of H₂SO₄ of molarity, M,
...
titration of excess of_H2SO4 = V₁ mL

VmL of NaOH of molarity M

4

= V₁ /2 mL of H₂SO₄ of molarity M
Volume of H₂SO₄ of molarity M unused
= (V - V₁/2) mL

4

(V- V₁/2) mL of H₂SO₄ of molarity M
...
2(V-V₁/2) mL of NH3 solution of

1000 mL of 1M NH3 solution contains
17g NH3 or 14 g of N

2(V-V₁/2) mL of NH3 solution of molarity M
...
Fig. 8.17 Carius method. Halogen containing
...
as ammonium phosphomolybdate, (NH4)3
PO4.12M0O3, by adding ammonia and
ammonium molybdate. Alternatively,
phosphoric acid may be precipitated as
MgNH PO by adding magnesia mixture which
on ignition yields Mg2P2O7.

4

Let the mass of organic compound taken
= mgand mass of ammonium phospho
molydate = mg
...
Percentage of phosphorus = 222

%

where, 222 u is the molar mass of Mg2P2O7,
m, the mass of organic compound taken,
m₁, the mass of Mg2P2O, formed and 62, the
mass of two phosphorus atoms present in the
compound Mg2P2O7.
...
in equation (B) by multiplying the equations
...
Let the mass of organic compound taken bem g
Mass of carbon dioxide produced be m₁ g

∴ m₁g carbon dioxide is obtained from
32 × m
...
according to which carbon can have sp³, sp² and sp hybridised orbitals. The sp³, sp² and sp
...
be understood on the basis of this concept. A sp³ hybrid orbital can overlap with 1s orbital
of hydrogen to give a carbon - hydrogen (C−H) single bond (sigma, σ bond). Overlap of a sp²
orbital of one carbon with sp² orbital of another results in the formation of a carbon-carbon
...
CH2=C=O, CH3CH=CH2, (CH3)2CO, CH2=CHCN, CH

8.2

Indicate the σ and a bonds in the following molecules :

CH, CH12, CH2Cl₂, CH2=C=CH2, CH3NO2, HCONHCH
...
Draw formulas for the first five members of each homologous series beginning with
...
Which of the two: O2NCH2CH2O¯ or CH3CH2O¯ is expected to be more stable and
why?
...
(a) CHOH (b) CHNO, (c) CH3CH=CHCHO (d) CH-CHO (e) CH-CH,
...
(b) (CH3)2C = CH2 + HCI → (CH₃)₂CIC – CH₃

(c) CH3CH2Br + HO¯ → CH₂ = CH2 + H2O + Br

(d) (CH3)3C− CH2OH + HBr → (CH₃)₂CBrCH2CH2CH3 + H₂O
...
Explain the terms Inductive and Electromeric effects. Which electron displacement

effect explains the following correct orders of acidity of the carboxylic acids?

(a) ClCCOOH > Cl₂CHCOOH > CICH2COOH

(b) CH3CH2COOH > (CH3)2CHCOOH > (CH3)3C.COOH

8.18

Give a brief description of the principles of the following techniques taking an
...
Differentiate between the principle of estimation of nitrogen in an organic compound
by (i) Dumas method and (ii) Kjeldahl's method.

8.23

Discuss the principle of estimation of halogens, sulphur and phosphorus present
...
Explain, why an organic liquid vaporises at a temperature below its boiling point
...
Will CCl give white precipitate of AgCl on heating it with silver nitrate? Give rea
for your answer.
...
Why is a solution of potassium hydroxide used to absorb carbon dioxide evolved
...
An organic compound contains 69% carbon and 4.8% hydrogen, the remainder
...
A sample of 0.50 g of an organic compound was treated according to Kjeldahl's
...
In the organic compound CH₂ = CH – CH₂ – CH₂ – C = CH, the pair of hydridised
...
In the Lassaigne's test for nitrogen in an organic compound, the Prussian blue
colour is obtained due to the formation of:

8.38

(a) Na [Fe(CN)](b) Fe4[Fe(CN)6]3 (c) Fe₂[Fe(CN)] (d) Fe3[Fe(CN)6]4
Which of the following carbocation is most stable ?

8.39

(a) (CH₃)₃C. CH₂(b) (CH) (c) CH₂CH₂CH₂ (d) CHCH CH₂CH₂
